...
public class AfterLoginConfig {
	...
	/**
	 * @param afterLoginControllerList The afterLoginControllerList to set.
	 */
	public void setAfterLoginControllerList(List<Map<String, Object>> afterLoginControllerList) {
