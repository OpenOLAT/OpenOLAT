 ...
 */
public class LowerThanEqualsOperator extends AbstractOperator {

	public transient final String OPERATOR = "<=";
	public transient final String OPERATORKEY = "le";
	public transient final String DISPLAY  = "operator.lowerThanEquals";
