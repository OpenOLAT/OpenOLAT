...
public class IQMenuDisplayConf {
	...
	private boolean renderSectionsOnly;
	private boolean enabledMenu; 
	private boolean itemPageSequence;

	public IQMenuDisplayConf(boolean renderSectionsOnly, boolean enabledMenu, boolean itemPageSequence) {
