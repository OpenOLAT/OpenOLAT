...
*Generated by `scripts/14_gen_translation_reference.py` on 2026-09-25 from the OpenOlat concept map, 911 terms. Do not edit this file by hand.*
...
| Assessment configuration | Konfiguration Bewertung | Configuración de la evaluación | Configuration évaluation | Configurazione della valutazione | Konfiguracja oceny |  | Konfigurácia hodnotenia |  |
...
| Extra time | Zusatzzeit | Tiempo adicional | Temps additionnel | Tempo aggiuntivo | Dodatkowy czas | Tempo extra | Dodatočný čas | Ekstra süre |
...
| Booking number | Buchungsnummer | Número de reserva | Numéro de réservation | Numero di prenotazione | Numer rezerwacji | Número de reserva | Číslo rezervácie | Rezervasyon numarası |
...
| Educational products | Bildungsprodukte | Productos educativos | Produits éducatifs | Prodotti formativi | Produkty edukacyjne |  | Vzdelávacie produkty |  |
...
| Publication | Veröffentlichung | Publicación | Publication | Pubblicazione | Publikacja | Lançamento | Publikovanie | Serbest bırak |
...
| Educational products | Bildungsprodukte | Productos educativos | Produits éducatifs | Prodotti formativi | Produkty edukacyjne |  | Vzdelávacie produkty |  |
| Course Planner | Course Planner | Course Planner | Course Planner | Course Planner | Course Planner |  | Course Planner |  |
...
| Participants can open the meeting | Teilnehmer{innen} können den Termin eröffnen | Los participantes pueden abrir la reunión | Les participant{e}s peuvent démarrer le meeting | I partecipanti possono aprire il meeting online | Uczestnicy mogą otworzyć spotkanie | Os participantes têm permissão para abrir a reunião | Účastníci môžu otvoriť online stretnutie | Katılımcıların toplantıyı açmasına izin verilir |
| Zoom | Zoom | Zoom | Zoom | Zoom | Zoom |  | Zoom |  |
...
| Days until deletion | Tage bis Löschung | Días hasta la eliminación | Jours jusqu'à l'effacement | Giorni fino alla cancellazione | Dni do usunięcia | Dias até a exclusão | Dni do vymazania | Silinmeye kalan gün sayısı |
...
| System settings | Einstellungen | Opciones | Paramètres | Impostazioni del sistema | Ustawienia | Configurações do sistema | Nastavenia systému | Sistem ayarları |
...
| Media Center | Media Center | Media Center | Media Center | Media Center | Media Center |  | Centrum médií |  |
| Question bank | Fragenpool | Banco de preguntas | Banque de questions | Pool delle domande | Baza pytań | Banco de perguntas | Databanka otázok | Soru bankası |
...
| Share | Teilen | Compartir | Partager | Condividere | Udostępnij | Compartilhar link para esta página | Zdieľať | Bu sayfanın bağlantısını paylaş |
...
| Glossary | Glossar | Glosario | Glossaire | Glossario | Słownik | Glossário | Slovník | Sözlük |
...
| Course planner | Kursplaner{in} | Planificador de cursos | Planificateur de cours | Pianificatore di corsi | Planista kursów |  | Plánovač kurzov |  |
