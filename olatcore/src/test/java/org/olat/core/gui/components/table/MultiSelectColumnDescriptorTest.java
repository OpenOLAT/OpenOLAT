 ...
 * @author patrick
 */
public class MultiSelectColumnDescriptorTest {

	private MultiSelectColumnDescriptor one;
	private MultiSelectColumnDescriptor sameRefAsOne;
	private MultiSelectColumnDescriptor two;
	private Table tableMockOne;
	private Table tableMockTwo;
	private MultiSelectColumnDescriptor sameAsOne;
	...
	public void setUp() throws Exception {
		...
		sameAsOne = new MultiSelectColumnDescriptor();
