...
//TODO: RH: remove this or really test for correct finding?!
	...
	@Test public void testMoveLanguageTask(){
		if (I18nModule.isTransToolEnabled()) {
			prepareDevToolTests();
			String srcPath = I18nModule.getTransToolCoreLanguagesSrcDir().getAbsolutePath() + "/../../test/java/org/olat/core/util/i18n/junittestdata/devtools";
	...
	@Test public void testSearchForAvailableLanguages() {
		if (I18nModule.isTransToolEnabled()) {
			...
			File testDataDir = new File(I18nModule.getTransToolCoreLanguagesSrcDir(), "/../../test/java/org/olat/core/util/i18n/junittestdata/");
