...
public abstract class NotificationsManager extends BasicManager {
	 ...
	 * 
	 * @see org.olat.notifications.NotificationsHandler and the corresponding code
	 *      in such as
	 ...
	 *      to inform the
	 * @see org.olat.notifications.NotificationsManagerImpl#markPublisherNews(SubscriptionContext,
	 *      Identity)
