...
public class QualityToDoTaskQueryTest extends OlatTestCase {
	...
	public void shouldGetTodos() {
		...
		// General qm todo
		ToDoTask toDoTask2 = toDoService.createToDoTask(member, GeneralToDoTaskProvider.TYPE, null, null, null);
		// General qm todo (not member)
		ToDoTask toDoTask3 = toDoService.createToDoTask(identity, GeneralToDoTaskProvider.TYPE, null, null, null);
		...
		ToDoTask toDoTask4 = toDoService.createToDoTask(identity, DataCollectionToDoTaskProvider.TYPE, dataCollection1.getKey(), null, null);
		// DataCollection ToDo not in organisation
		QualityDataCollection dataCollection2 = qualityTestHelper.createDataCollection();
		ToDoTask toDoTask5 = toDoService.createToDoTask(identity, DataCollectionToDoTaskProvider.TYPE, dataCollection2.getKey(), null, null);
	...
	public void shouldGetTodos_excludeGeneralIfNotMaanger() {
		...
		toDoService.createToDoTask(identity, GeneralToDoTaskProvider.TYPE, null, null, null);
		dbInstance.commitAndCloseSession();
