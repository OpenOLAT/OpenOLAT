 ...
 *
 */
public class RepositoryQualityContextBuilderTest extends OlatTestCase {
	...
	public void shouldInitWithAllRelations() {
		...
		QualityContext context = RepositoryQualityContextBuilder
				.builder(dataCollection, evaluationFormParticipation, entry, roles).build();
		...
		assertThat(context.getRepositoryEntry()).isEqualTo(entry);
