...
public class ContactTracingRegistrationDAOTest extends OlatTestCase {
	...
	public void shouldCreateAndPersistRegistration() {
		...
		ContactTracingRegistration registration = sut.create(location, startDate, deletionDate, ImmunityProofLevel.none);
	...
	public void shouldDeleteByLocations() {
		...
		ContactTracingRegistration registration11 = sut.persist(sut.create(location1, new Date(), new Date(), ImmunityProofLevel.none));
		ContactTracingRegistration registration12 = sut.persist(sut.create(location1, new Date(), new Date(), ImmunityProofLevel.none));
		...
		ContactTracingRegistration registration21 = sut.persist(sut.create(location2, new Date(), new Date(), ImmunityProofLevel.none));
		...
		ContactTracingRegistration registrationNotDeleted = sut.persist(sut.create(locationNotDeleted, new Date(), new Date(), ImmunityProofLevel.none));
		dbInstance.commitAndCloseSession();
	...
	public void shouldPruneRegistartions() {
		ContactTracingLocation location = locationDao.createAndPersistLocation(random(), random(), random(), random(), random(), random(), randomBoolean(), random(), random(), false);
		ContactTracingRegistration registration11 = sut.persist(sut.create(location, new Date(), DateUtils.addHours(new Date(), -1), ImmunityProofLevel.none));
		ContactTracingRegistration registration12 = sut.persist(sut.create(location, new Date(), DateUtils.addHours(new Date(), -2), ImmunityProofLevel.none));
		ContactTracingLocation location2 = locationDao.createAndPersistLocation(random(), random(), random(), random(), random(), random(), randomBoolean(), random(), random(), false);
		ContactTracingRegistration registration21 = sut.persist(sut.create(location2, new Date(), DateUtils.addDays(new Date(), -1), ImmunityProofLevel.none));
		...
		ContactTracingRegistration registrationNotPruned = sut.persist(sut.create(locationPruned, new Date(), DateUtils.addHours(new Date(), 11), ImmunityProofLevel.none));
		dbInstance.commitAndCloseSession();
	...
	public void shouldFilterByLocation() {
		...
		ContactTracingRegistration registrationOther = sut.persist(sut.create(locationOther, new Date(), new Date(), ImmunityProofLevel.none));
		dbInstance.commitAndCloseSession();
	...
	public void shouldFilterByStart() {
		ContactTracingLocation location = locationDao.createAndPersistLocation(random(), random(), random(), random(), random(), random(), randomBoolean(), random(), random(), false);
		ContactTracingRegistration registration11 = sut.persist(sut.create(location, DateUtils.addHours(new Date(), 1), new Date(), ImmunityProofLevel.none));
		ContactTracingRegistration registration12 = sut.persist(sut.create(location, DateUtils.addHours(new Date(), 2), new Date(), ImmunityProofLevel.none));
		ContactTracingRegistration registrationOther = sut.persist(sut.create(location, DateUtils.addHours(new Date(), -1), new Date(), ImmunityProofLevel.none));
		dbInstance.commitAndCloseSession();
	...
	public void shouldFilterByEnd() {
		ContactTracingLocation location = locationDao.createAndPersistLocation(random(), random(), random(), random(), random(), random(), randomBoolean(), random(), random(), false);
		ContactTracingRegistration registration11 = sut.create(location, new Date(), new Date(), ImmunityProofLevel.none);
		registration11.setEndDate(DateUtils.addHours(new Date(), -1));
		registration11 = sut.persist(registration11);
		ContactTracingRegistration registration12 = sut.create(location, new Date(), new Date(), ImmunityProofLevel.none);
		registration12.setEndDate(DateUtils.addHours(new Date(), -2));
		registration12 = sut.persist(registration12);
		ContactTracingRegistration registrationOther = sut.create(location, new Date(), new Date(), ImmunityProofLevel.none);
	...
	public void shouldTestIfAnyRegistrationAvailable() {
		ContactTracingLocation location1 = locationDao.createAndPersistLocation(random(), random(), random(), random(), random(), random(), randomBoolean(), random(), random(), false);
		sut.persist(sut.create(location1, new Date(), DateUtils.addHours(new Date(), -1), ImmunityProofLevel.none));
		dbInstance.commitAndCloseSession();
	...
	public void shouldAddSeatNumber() {
		...
		ContactTracingRegistration registration1 = sut.create(location, new Date(), new Date(), ImmunityProofLevel.none);
		...
		ContactTracingRegistration registration2 = sut.create(location, new Date(), new Date(), ImmunityProofLevel.none);
