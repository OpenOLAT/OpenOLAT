...
public class ShibbolethManagerImplTest {
	...
	public void setUp() {
		...
		when(securityManagerMock.createAndPersistIdentityAndUserWithOrganisation(eq(null), anyString(), isNull(), any(User.class), anyString(), anyString(), eq(null), anyString(), eq(null), eq(null), eq(null), eq(null)))
				.thenReturn(identityMock);
	...
	public void shouldCreateAndPersistNewUser() {
		...
		verify(securityManagerMock).createAndPersistIdentityAndUserWithOrganisation(
				eq(null), anyString(), eq(null), eq(userMock), eq(ShibbolethDispatcher.PROVIDER_SHIB), eq(BaseSecurity.DEFAULT_ISSUER), eq(null), anyString(), eq(null), eq(null), eq(null), eq(null));
	}
	...
	public void shouldAddUserToAuthorGroupIfIsAuthorWhenCreating() {
		...
		verify(organisationServiceMock).addMember(identityMock, OrganisationRoles.author, identityMock);
	}
