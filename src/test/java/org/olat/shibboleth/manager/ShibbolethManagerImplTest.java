...
public class ShibbolethManagerImplTest {
	...
	public void setUp() {
		...
		when(securityManagerMock.createAndPersistIdentityAndUser(eq(null), anyString(), isNull(), any(User.class), anyString(), anyString(), eq(null), eq(null)))
				.thenReturn(identityMock);
		when(securityManagerMock.createAndPersistIdentityAndUserWithOrganisation(eq(null), anyString(), isNull(), any(User.class), anyString(), anyString(), eq(null), eq(null), eq(null)))
				.thenReturn(identityMock);
	...
	public void shouldCreateAndPersistNewUser() {
		...
		verify(securityManagerMock).createAndPersistIdentityAndUserWithOrganisation(
				eq(null), anyString(), eq(null), eq(userMock), eq(ShibbolethDispatcher.PROVIDER_SHIB), anyString(), eq(null), eq(null), eq(null));
	}
