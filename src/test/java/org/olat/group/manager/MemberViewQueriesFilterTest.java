...
public class MemberViewQueriesFilterTest {
	...
	public void filterByRolesOneRoleAndPending() {
		...
		MemberView owner = new MemberView(null);
		owner.getMemberShip().setRepositoryEntryOwner(true);
		MemberView coach = new MemberView(null);
