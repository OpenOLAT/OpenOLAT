...
public class LectureRepositoryAdminListPage {
	...
	public ImportLecturesBlocksWizard importLecturesBlocks() {
		By moreBy = By.xpath("//div[contains(@class,'o_sel_repo_lectures_list')]/div[contains(@class,'o_flex_first_grow')]/div[contains(@class,'btn-group')][a[contains(@class,'o_sel_repo_add_lecture')]]/div/button[contains(@class,'o_sel_add_more')]");
