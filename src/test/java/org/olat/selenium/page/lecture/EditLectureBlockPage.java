...
public class EditLectureBlockPage {
	...
	public EditLectureBlockPage setDate(int day, int startHour, int startMinute, int endHour, int endMinute) {
		String dateMsXpath = "//fieldset[contains(@class,'o_sel_repo_edit_lecture_form')]//div[contains(@class,'o_date_ms')]/input[@type='text']";
		By startHourBy = By.xpath(dateMsXpath + "[1]");
		browser.findElement(startHourBy).sendKeys(Integer.toString(startHour));
		By startMinuteBy = By.xpath(dateMsXpath + "[2]");
		browser.findElement(startMinuteBy).sendKeys(Integer.toString(startMinute));
		By endHourBy = By.xpath(dateMsXpath + "[3]");
		browser.findElement(endHourBy).sendKeys(Integer.toString(endHour));
		By endMinuteBy = By.xpath(dateMsXpath + "[4]");
		browser.findElement(endMinuteBy).sendKeys(Integer.toString(endMinute));
