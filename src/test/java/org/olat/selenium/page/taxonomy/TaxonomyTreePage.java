...
public class TaxonomyTreePage {
	...
	public TaxonomyTreePage atLeastOneLevel(String identifier, String name) {
		By tableTreeBy = By.cssSelector("div.o_sel_taxonomy_levels_tree");
	...
	public TaxonomyLevelPage selectTaxonomyLevel(String identifier, String title) {
		...
		return new TaxonomyLevelPage(browser).assertOnTaxonomyLevel(title);
	}
