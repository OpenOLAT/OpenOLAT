 ...
 *
 */
public class ExportMetadataToOrganisationDAOTest extends OlatTestCase {
	...
	public void createRelation() {
		...
		Organisation organisation = organisationService.createOrganisation("Metadata - 1", "MD-1", null, null, null, actor);
