...
public class AverageCompletionEvaluatorTest {
	...
	private AssessmentEvaluation createAssessmentEvaluation(AssessmentObligation obligation, Integer duration,
		...
		return new AssessmentEvaluation(null, null, null, null, completion, status, null, fullyAssessed, null, null,
				null, null, null, null, 0, null, null, null, null, null, null, Overridable.of(obligation), duration,
				null, null);
	}
