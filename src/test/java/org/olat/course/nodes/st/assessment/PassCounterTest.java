...
public class PassCounterTest {
	...
	public void shouldGetCummulatingScore() {
		...
		AssessmentEvaluation child11Evaluation = createAssessmentEvaluation(Boolean.TRUE, Boolean.TRUE);
		...
		AssessmentEvaluation child12Evaluation = createAssessmentEvaluation(Boolean.FALSE, Boolean.TRUE);
		...
		AssessmentEvaluation child13Evaluation = createAssessmentEvaluation(Boolean.FALSE, Boolean.FALSE);
		...
		AssessmentEvaluation child14Evaluation = createAssessmentEvaluation(Boolean.TRUE, Boolean.FALSE);
		...
		AssessmentEvaluation child15Evaluation = createAssessmentEvaluation(Boolean.TRUE, Boolean.TRUE);
		...
		AssessmentEvaluation child16Evaluation = createAssessmentEvaluation(null, Boolean.TRUE);
		...
		AssessmentEvaluation child17Evaluation = createAssessmentEvaluation(Boolean.TRUE, Boolean.TRUE);
		...
		// Child: set by node, passed, user visible, ignored
		CourseNode child18 = new Card2BrainCourseNode();
		parent.addChild(child18);
		AssessmentEvaluation child18Evaluation = createAssessmentEvaluation(Boolean.TRUE, Boolean.TRUE);
		...
		AssessmentEvaluation child21Evaluation = createAssessmentEvaluation(Boolean.TRUE, Boolean.TRUE);
	...
	private AssessmentEvaluation createAssessmentEvaluation(Boolean passed, Boolean userVisibility) {
		return new AssessmentEvaluation(null, passed, null, null, null, null, userVisibility, null, null, null, null, null,
