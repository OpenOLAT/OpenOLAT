...
public class OrganisationExceptionalObligationHandlerTest {
	...
	public void shouldMatchIdentiyByOrganisation() {
		OrganisationExceptionalObligationHandler sut = new OrganisationExceptionalObligationHandler();
		...
		OrganisationRef organisationRef = () -> 12L;
		hit.setOrganisationRef(organisationRef);
		hit.setObligation(AssessmentObligation.optional);
		obligationContext.addOrganisationRef(organisationRef);
		OrganisationExceptionalObligation miss = new OrganisationExceptionalObligation();
		miss.setOrganisationRef(() -> 13L);
