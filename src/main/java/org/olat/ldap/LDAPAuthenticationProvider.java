...
public class LDAPAuthenticationProvider extends AuthenticationProvider {
	...
	@Value("${ldap.issuer.identifier:null}")
	private String issuerIdentifier;

	protected LDAPAuthenticationProvider(String name, String clazz, boolean enabled, boolean isDefault,
			String iconCssClass) {
