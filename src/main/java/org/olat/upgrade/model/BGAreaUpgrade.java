 ...
 * @author gnaegi
 */
public class BGAreaUpgrade extends PersistentObject {
	 ...
	 */
	protected BGAreaUpgrade() {
	// nothing to do
	}
	
	BGAreaUpgrade(String name, String description, OLATResource resource) {
		setName(name);
	...
	public boolean equals(Object obj) {
		...
		if(obj instanceof BGAreaUpgrade) {
			BGAreaUpgrade area = (BGAreaUpgrade)obj;
