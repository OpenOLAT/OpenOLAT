...
public class SecurityAdminConfigurationController extends FormBasicController {
	...
	protected void initForm(FormItemContainer formLayout, Controller listener, UserRequest ureq) {
		...
		resourcesCont.setFormContextHelp("manual_admin/administration/Login_Security/");
		...
		formActionEl.setExampleKey("sec.csp.default.value", new String[] { cspBuilder.formAction().toString(), EXAMPLE });
		...
		frameAncestorsEl.setExampleKey("sec.csp.default.value", new String[] { cspBuilder.frameAncestors().toString(), EXAMPLE });
