...
public class UserImportContext {
	...
	public UserImportContext(boolean canCreateOLATPassword, Organisation preselectedOrganisation) {
		this.canCreateOLATPassword = canCreateOLATPassword;
		this.preselectedOrganisation = preselectedOrganisation;
	}
	
	public boolean canCreateOLATPassword() {
		return canCreateOLATPassword;
	}
	
	public Organisation getPreselectedOrganisation() {
		return preselectedOrganisation;
	}
}
