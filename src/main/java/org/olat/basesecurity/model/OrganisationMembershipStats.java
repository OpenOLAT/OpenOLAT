 ...
 *
 */
public class OrganisationMembershipStats {
	
	private final OrganisationRoles role;
	private final long numOfMembers;
	
	public OrganisationMembershipStats(OrganisationRoles role, Long numOfMembers) {
		this.role = role;
		this.numOfMembers = (numOfMembers == null ? 0l : numOfMembers.longValue());
	}
