...
/**
 * 
 * Initial date: Nov 14, 2025<br>
 * @author uhensler, urs.hensler@frentix.com, https://www.frentix.com
 *
 */
public class QTI21ExportsListController extends ExportsListController {

	public QTI21ExportsListController(UserRequest ureq, WindowControl wControl, RepositoryEntry entry, String subIdent,
			boolean admin, ExportsListSettings options, Translator translator) {
		super(ureq, wControl, entry, subIdent, admin, options, translator);
	}
