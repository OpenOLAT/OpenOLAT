 ...
 *
 */
public class QTI21MetadataConverter {
	...
	QTI21MetadataConverter(Element qtimetadata) {
		this.qtimetadata = qtimetadata;
	}
	
	QTI21MetadataConverter(Element qtimetadata, QItemTypeDAO itemTypeDao, QEducationalContextDAO educationalContextDao,
	...
	public QTI21MetadataConverter(QItemTypeDAO itemTypeDao, QEducationalContextDAO educationalContextDao,
			QPoolService qpoolService) {
