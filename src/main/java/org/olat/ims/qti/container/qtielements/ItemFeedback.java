 ...
 * @author Mike Stock
 */
public class ItemFeedback extends GenericQTIElement {

	private static final long serialVersionUID = -1316026995098502866L;
	/**
	 * Comment for <code>xmlClass</code>
	 */
	public static final String xmlClass = "itemfeedback";

	/**
	 * @param el_itemfeedback
	 */
	public ItemFeedback(Element el_itemfeedback) {
		super(el_itemfeedback);
	}
	...
	public void render(StringBuilder buffer, RenderInstructions ri) {
		buffer.append("<div class=\"o_qti_item_itemfeedback\">");
