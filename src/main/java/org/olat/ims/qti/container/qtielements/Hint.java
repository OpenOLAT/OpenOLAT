...
public class Hint extends GenericQTIElement {
	 ...
	 */
	public static final String xmlClass = "hint";
	 ...
	 * @param el_hint
	 */
	public Hint(Element el_hint) {
		super(el_hint);
		String fbstyle = el_hint.attributeValue("feedbackstyle");
		if (fbstyle != null) {
			...
			else throw new AssertException("Invalid feedbackstyle in hint element " + getIdent() + ": " + fbstyle);
		}
	}
