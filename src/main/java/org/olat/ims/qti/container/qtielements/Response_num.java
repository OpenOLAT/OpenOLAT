 ...
 * @author Mike Stock
 */
public class Response_num extends GenericQTIElement {

	private static final long serialVersionUID = -4169461708824134084L;

	/**
	 * Comment for <code>xmlClass</code>
	 */
	public static final String xmlClass = "response_num";
	 ...
	 */
	public Response_num(Element el_response_lid) {
