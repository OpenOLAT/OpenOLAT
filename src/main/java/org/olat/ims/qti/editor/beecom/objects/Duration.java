...
public class Duration implements QTIObject {
	...
	public Duration(String sMin, String sSec) {
	...
	public void setDuration(String min, String sec) {
		try {
	...
	public int getSec() { return iSec; }
	
	public boolean isSet() { return getMillis() > 0; }
}
