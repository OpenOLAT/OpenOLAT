 ...
 * @author gnaegi<br>
 * 
 * Comment: Parser for the selection_ordering elements (at section level).
 * Uses the number of choosen items from the selection_number element if available
 * and the ordering type from the order element. Uses default values from the 
 * SelectionOrdering class in cases of non exising elements
 * </pre>
 */
