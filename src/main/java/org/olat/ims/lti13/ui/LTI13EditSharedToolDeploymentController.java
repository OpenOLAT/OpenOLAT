...
public class LTI13EditSharedToolDeploymentController extends FormBasicController {
	...
	public LTI13EditSharedToolDeploymentController(UserRequest ureq, WindowControl wControl, LTI13SharedTool sharedTool) {
		super(ureq, wControl);
	...
	protected void initForm(FormItemContainer formLayout, Controller listener, UserRequest ureq) {
		deploymentIdEl = uifactory.addTextElement("deployment.id", 255, null, formLayout);
	...
	protected void formOK(UserRequest ureq) {
		...
		sharedTool = lti13Service.getSharedToolByKey(sharedTool.getKey());
		lti13Service.getOrCreateSharedToolDeployment(deploymentId, sharedTool);
