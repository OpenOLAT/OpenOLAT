...
public enum RepositoryEntryStatusEnum {
	...
	preparation("cif.status.preparation"),
	review("cif.status.review"),
	coachpublished("cif.status.coachpublished"),
	published("cif.status.published"),
	closed("cif.status.closed"),
	trash("cif.status.trash"),
	deleted("cif.status.deleted");

	private final String i18nKey;

	private RepositoryEntryStatusEnum(String i18nKey) {
