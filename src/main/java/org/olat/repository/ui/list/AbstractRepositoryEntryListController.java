 ...
 */
public abstract class AbstractRepositoryEntryListController extends FormBasicController
	...
	protected abstract void doFilter(List<Filter> filters);
	
	protected abstract void doOrderBy(OrderBy orderBy);
