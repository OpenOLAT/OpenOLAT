...
/**
 * Displays the "Meet your teachers" list of portraits for both a course
 * (RepositoryEntry) and a curriculum implementation. Purely a display
 * component: which identities to show is loaded by the caller (the data
 * source differs between a RepositoryEntry and a CurriculumElement) and
 ...
 *
 */
public class InfoTaughtByController extends BasicController {
	...
	public InfoTaughtByController(UserRequest ureq, WindowControl wControl, Set<Identity> taughtBys) {
		super(ureq, wControl);
		setTranslator(Util.createPackageTranslator(RepositoryService.class, getLocale(), getTranslator()));

		mainVC = createVelocityContainer("taught_by");
