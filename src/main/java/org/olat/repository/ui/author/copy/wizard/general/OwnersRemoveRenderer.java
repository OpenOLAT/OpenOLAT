 ...
 */
public class OwnersRemoveRenderer extends StaticFlexiCellRenderer {
	
	private final Identity executingIdentity;
	
	public OwnersRemoveRenderer(Identity executingIdentity, String translatedAction, String action) {
		super(translatedAction, action);
	...
	public void render(Renderer renderer, StringOutput target, Object cellValue, int row, FlexiTableComponent source,
		...
		if (rowObject instanceof Identity) {
			...
			if (!rowIdentity.equalsByPersistableKey(executingIdentity)) {
