...
public class RepositoryAdminController extends FormBasicController {
	...
	protected void initForm(FormItemContainer formLayout, Controller listener, UserRequest ureq) {
		...
		boolean statusChangedNotificationEnabled = repositoryModule.isRepoStatusChangedNotificationsEnabled();
	...
	protected void formInnerEvent(UserRequest ureq, FormItem source, FormEvent event) {
		if(myCourseSearchEl == source) {
			...
			repositoryModule.setRepoStatusChangedNotificationsEnabled(notificationEl.isKeySelected(NOTIFICATION_REPOSITORY_STATUS_CHANGED));
			getWindowControl().setInfo("saved");
