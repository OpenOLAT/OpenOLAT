 ...
 */
public class BGEmailCompositionStep extends BasicStep {
	
	private final List<BusinessGroup> groups;
	
	public BGEmailCompositionStep(UserRequest ureq, List<BusinessGroup> groups) {
		super(ureq);
		this.groups = groups;
		setI18nTitleAndDescr("email.write.title", "email.write.description");
