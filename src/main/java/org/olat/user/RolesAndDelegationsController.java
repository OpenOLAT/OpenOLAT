...
public class RolesAndDelegationsController extends BasicController {
	...
	protected RolesAndDelegationsController(UserRequest ureq,
		...
		myContent.contextPut("isOLATAdmin", userRoles.isAdministrator());
		...
		myContent.contextPut("isInstitutionalResourceManager", userRoles.isLearnResourceManager());
		myContent.contextPut("isPoolAdmin", userRoles.isPoolManager());
	}
