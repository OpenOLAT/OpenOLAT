 ...
 *
 */
public class ImportExternalProviderCellRenderer implements FlexiCellRenderer {
	
	private final Translator translator;
	
	public ImportExternalProviderCellRenderer(Translator translator) {
	...
	public void render(Renderer renderer, StringOutput target, Object cellValue, int row, FlexiTableComponent source,
		...
		if(i18nProviderKey != null) {
			target.append(translator.translate(i18nProviderKey));
		}
	}
}
