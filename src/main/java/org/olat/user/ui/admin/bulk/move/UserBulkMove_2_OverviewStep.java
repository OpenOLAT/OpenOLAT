 ...
 *
 */
public class UserBulkMove_2_OverviewStep extends BasicStep {
	
	private final UserBulkMove userBulkMove;
	
	public UserBulkMove_2_OverviewStep(UserRequest ureq, UserBulkMove userBulkMove) {
		super(ureq);
	...
	public StepFormController getStepController(UserRequest ureq, WindowControl wControl,
		...
		return new OverviewMoveController(ureq, wControl, userBulkMove, form, stepsRunContext);
	}
}
