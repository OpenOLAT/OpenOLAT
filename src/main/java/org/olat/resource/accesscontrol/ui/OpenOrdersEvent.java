 ...
 *
 */
public class OpenOrdersEvent extends Event {

	private static final long serialVersionUID = -2546585578885524715L;

	public static final String OPEN_ORDERS = "open-orders";
	
	private final OfferAccess offerAccess;
	
	public OpenOrdersEvent(OfferAccess offerAccess) {
		super(OPEN_ORDERS);
