 ...
 *
 */
public class PaypalCheckoutAdminAdditionalController extends FormBasicController {
	
	private FormLink vatLink;

	public PaypalCheckoutAdminAdditionalController(UserRequest ureq, WindowControl wControl) {
		super(ureq, wControl);
		initForm(ureq);
	}
