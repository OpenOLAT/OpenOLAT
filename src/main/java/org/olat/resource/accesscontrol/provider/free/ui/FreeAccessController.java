 ...
 *
 */
public class FreeAccessController extends AbstractAccessController {

	private final Identity identity;

	public FreeAccessController(UserRequest ureq, WindowControl wControl, OfferAccess link, Identity identity) {
	...
	protected Controller createDetailsController(UserRequest ureq, WindowControl wControl, OfferAccess link) {
		return new FreeSubmitController(ureq, wControl, link, identity);
	}
