...
public class GuiDemoLinksController extends BasicController {
	...
	class FormButtonsDemoController extends FormBasicController {
		...
		protected void initForm(FormItemContainer formLayout, Controller listener, UserRequest ureq) {
			uifactory.addToggleButton("toggle1", null, "Toggle on", "toggle off", formLayout);			
			FormToggle fi1 = uifactory.addToggleButton("toggle_slide1", null, null, null, formLayout);
			fi1.toggleOn();
