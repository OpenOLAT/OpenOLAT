...
public class GuiDemoFlexiSingleSelectionController extends FormBasicController {
	...
	private void initButtonGroupExamples(FormItemContainer formLayout) {
		...
		uifactory.addButtonGroupSingleSelectHorizontal("single.select.buttongroup.3", formLayout, planets3);
		...
		SingleSelection vertBtnGroup = uifactory.addButtonGroupSingleSelectHorizontal("single.select.buttongroup.8", formLayout, planets8);
