 ...
 */
public class BlogFileResource extends FeedFileResource {
	public static final String TYPE_NAME = "FileResource.BLOG";

	/**
	 * Default Constructor
	 */
	public BlogFileResource() {
		super(TYPE_NAME);
	}
	 ...
	 */
	public BlogFileResource(File root, File resourceFolder) {
