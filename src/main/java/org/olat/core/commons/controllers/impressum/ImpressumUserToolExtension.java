 ...
 *
 */
public class ImpressumUserToolExtension extends UserToolExtension {

	private ImpressumModule impressumModule;
	
	/**
	 * [used by Spring]
	 * @param impressumModule
	 */
	public void setImpressumModule(ImpressumModule impressumModule) {
		this.impressumModule = impressumModule;
	}
	
	@Override
	public String getShortCutCssId() {
		return "o_navbar_impress";
	}
	...
	public String getUniqueExtensionID() {
		return "org.olat.home.HomeMainController:org.olat.instantMessaging.ui.ImpressumMainController";
	}

	@Override
	public UserTool createUserTool(UserRequest ureq, WindowControl wControl, Locale locale) {
		return new ImpressumUserTool();
	}
