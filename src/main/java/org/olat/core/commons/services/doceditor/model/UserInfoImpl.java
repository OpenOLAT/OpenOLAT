 ...
 *
 */
@Entity(name="doceditoruserinfo")
@Table(name="o_de_user_info")
public class UserInfoImpl implements UserInfo, Persistable {
	
	private static final long serialVersionUID = -9211147243926628595L;
