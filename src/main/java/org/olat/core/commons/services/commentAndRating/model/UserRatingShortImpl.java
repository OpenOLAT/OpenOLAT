 ...
 * @author gnaegi
 */
@Entity(name="userratingshort")
@Table(name="o_userrating")
public class UserRatingShortImpl implements Persistable, CreateInfo, UserRating {
	...
	public IdentityRef getCreator() {
		return new IdentityRefImpl(creatorKey);
	}
	...
	public boolean equals(Object obj) {
		...
		if(obj instanceof UserRatingShortImpl) {
			UserRatingShortImpl q = (UserRatingShortImpl)obj;
