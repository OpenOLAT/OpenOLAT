 ...
 */
@Component
public class Office365DirectiveProvider implements CSPDirectiveProvider {
	...
	private Collection<String> getUrls() {
		return office365Module.isEnabled()? office365Service.getContentSecurityPolicyUrls(): null;
	}
