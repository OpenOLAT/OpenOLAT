...
/**
 * 
 * Initial date: 7 Aug 2023<br>
 * @author uhensler, urs.hensler@frentix.com, http://www.frentix.com
 *
 */
@Component
public class DrawioDirectiveProvider implements CSPDirectiveProvider {
	...
	private Collection<String> getUrls() {
		return drawioModule.isEnabled()? List.of(drawioModule.getEditorUrl()): null;
	}
