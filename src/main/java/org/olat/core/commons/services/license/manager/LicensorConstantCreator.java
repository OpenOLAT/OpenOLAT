 ...
 */
@Component
public class LicensorConstantCreator implements LicensorCreator {

	public static final String CONSTANT_CREATOR_TYPE = "constant";
	...
	public String create(LicenseHandler handler, Identity identity) {
		return licenseModule.getConstantLicensor(handler);
	}
