 ...
 */
@Component
public class OnlyOfficeDirectiveProvider implements CSPDirectiveProvider {
	...
	private Collection<String> getUrls() {
		return onlyOfficeModule.isEnabled()? Collections.singletonList(onlyOfficeModule.getBaseUrl()): null;
	}
