 ...
 *
 */
@Entity(name="exportmetadatatocurriculum")
@Table(name="o_ex_export_metadata_to_cur")
public class ExportMetadataToCurriculumImpl implements ExportMetadataToCurriculum, Persistable {
	...
	public boolean equals(Object obj) {
		...
		if(obj instanceof ExportMetadataToCurriculumImpl exp) {
