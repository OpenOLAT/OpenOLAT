...
/**
 * Description:<br>
 * Brasato defines several different layouts for pop-up windows. Within
 * application all pop-up windows which are not using the default - have to be
 * layouted with the BaseFullWebappPopupLayoutFactory.
 * 
 * <P>
...
public interface BaseFullWebappPopupLayout extends ControllerCreator {
	...
	/**
	 * the screen parts static tabs, footer, header, logo, topnav and also the
	 * content controller creator are defined inside the controller parts.
	 * 
