 ...
 *
 */
class BaseFullWebappPrintLayoutControllerCreator implements BaseFullWebappPopupLayout {
	private ControllerCreator contentControllerCreator;

	
	BaseFullWebappPrintLayoutControllerCreator(ControllerCreator contentControllerCreator){
