 ...
 *
 */
public class MaxHeightScrollableDelegate implements FlexiTableCssDelegate {
	
	public static final FlexiTableCssDelegate DELEGATE = new MaxHeightScrollableDelegate();
