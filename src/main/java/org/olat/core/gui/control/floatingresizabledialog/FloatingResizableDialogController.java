...
public class FloatingResizableDialogController extends BasicController {
	...
	public FloatingResizableDialogController(UserRequest ureq, WindowControl wControl,
		...
		JSAndCSSComponent js = new JSAndCSSComponent("js", new String[] { "js/jquery/ui/jquery-ui-1.13.2.dialog.min.js" }, null);
	...
	public Command getCloseCommand () {
		return FunctionCommand.closeDialog(getPanelName());
	}
