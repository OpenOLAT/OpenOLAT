 ...
 *
 */
public class FlexiFilterTabsComponent extends FormBaseComponentImpl implements ComponentCollection {
	
	private static final FlexiFilterTabsComponentRenderer RENDERER = new FlexiFilterTabsComponentRenderer();
	
	private final FlexiFilterTabsElementImpl element;
	
	public FlexiFilterTabsComponent(FlexiFilterTabsElementImpl element, Translator translator) {
