...
public class MultiSelectionFilterComponent extends AbstractComponent {
	...
	private final MultiSelectionFilterElementImpl taxonomyLevelSelection;

	public MultiSelectionFilterComponent(String name, MultiSelectionFilterElementImpl taxonomyLevelSelection) {
		super(name);
		this.taxonomyLevelSelection = taxonomyLevelSelection;
	}
