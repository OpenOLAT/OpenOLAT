 ...
 *
 */
public abstract class AdditionalWidget extends Widget {
	
	private String additionalCssClass;
	private String additionalText;
	private Component additionalComp;

	protected AdditionalWidget(String name) {
		super(name);
	}
	...
	public Component getAdditionalComp() {
		return additionalComp;
	}

	public void setAdditionalComp(Component additionalComp) {
