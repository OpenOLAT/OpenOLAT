...
/**
 * A <b>OLATResourceImpl</b> is a generic identifier for objects in OLAT.
 * Its unique identifier is build from a type name and an identifyer.
 * 
...
public interface OLATResourceable {
	...
	/**
	 * 
	 * @return a type name. It must be unique within OLAT.
