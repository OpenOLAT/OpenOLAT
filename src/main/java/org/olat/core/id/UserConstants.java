...
public class UserConstants {
	...
	/** ZIPCODE user field identifier. */
	public static final String ZIPCODE = "zipCode";
	/** REGION user field identifier. */
	public static final String REGION = "region";
	/** CITY user field identifier. */
	public static final String CITY = "city";
	/** COUNTRY user field identifier. */
	public static final String COUNTRY = "country";
	/** ORGUNIT user field identifier. */
	...
	public static final String INFORMSESSIONTIMEOUT = "informSessionTimeout";
