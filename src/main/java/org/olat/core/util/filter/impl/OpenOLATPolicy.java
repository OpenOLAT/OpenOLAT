...
public class OpenOLATPolicy {
	...
	private static final String[] VARIABLES = new String[] { "$courseUrl", "$groupUrl", "$curriculumUrl", "$myCoursesUrl" };
	...
	public static final PolicyFactory POLICY_DEFINITION = new HtmlPolicyBuilder()
		...
		.allowAttributes("class")
			.matching(HTMLCLASS).onElements("audio", "video", "object")
		.allowAttributes("height")
			.matching(NUMBER).onElements("video", "object")
		.allowAttributes("width")
			.matching(NUMBER).onElements("video", "object")
