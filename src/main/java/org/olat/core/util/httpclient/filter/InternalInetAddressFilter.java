 ...
 * <p>Copied from Spring Framework 7.1
 *
 ...
 * @author Phillip Webb
 */
public final class InternalInetAddressFilter implements InetAddressFilter {

	private static final byte[] NAT64_PREFIX = { (byte) 0x00, (byte) 0x64, (byte) 0xff, (byte) 0x9b };

	public static final InternalInetAddressFilter instance = new InternalInetAddressFilter();
