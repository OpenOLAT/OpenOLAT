...
public class DocumentNotImplementedException extends Exception {
	 ...
	 * @param suffix of the given document
	 * @param filename of the given document
	 */
	public DocumentNotImplementedException(String suffix, String filename) {
		super("Lucene document for suffix " + suffix + " (file " + filename + ") not implemented.");
	}
}
