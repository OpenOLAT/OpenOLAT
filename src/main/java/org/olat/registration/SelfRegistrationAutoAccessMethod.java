 ...
 */
@Entity(name="selfregistrationautoacmethod")
@DiscriminatorValue(value="auto.self.registration.method")
public class SelfRegistrationAutoAccessMethod extends AutoAccessMethod {

	private static final long serialVersionUID = 73214873269862L;
