 ...
 *
 */
public class CalendarGUIMoveEvent extends FormEvent {

	private static final long serialVersionUID = -5910033103406371704L;
	public static final String CMD_MOVE = "mvcalevent";
	
	private Boolean allDay;
	private Long dayDelta, minuteDelta;
	private KalendarEvent	event;
	private KalendarRenderWrapper calendarWrapper;
	
	public CalendarGUIMoveEvent(FormItem item, KalendarEvent event, KalendarRenderWrapper calendarWrapper,
