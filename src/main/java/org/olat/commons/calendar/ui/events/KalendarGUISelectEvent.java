 ...
 *
 */
public class KalendarGUISelectEvent extends FormEvent {
	...
	public KalendarGUISelectEvent(FormItem item, KalendarEvent event, KalendarRenderWrapper calendarWrapper, String targetDomId) {
