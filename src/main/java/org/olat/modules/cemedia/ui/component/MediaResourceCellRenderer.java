 ...
 *
 */
public class MediaResourceCellRenderer extends StaticFlexiCellRenderer {
	
	public MediaResourceCellRenderer(String action) {
		super("", action);
	}
	...
	public void render(Renderer renderer, StringOutput target, Object cellValue, int row, FlexiTableComponent source,
		...
		if(cellValue instanceof MediaUsageRow usageRow) {
			if(usageRow.isAccess()) {
				...
				String href = usageRow.getResourceUrl() == null ? "javascript:;" : usageRow.getResourceUrl();
	...
	private void render(StringOutput target, MediaUsageRow usageRow) {
		target.append("<span><i class=\"o_icon ").appendCssClassEscaped(usageRow.getResourceIconCssClass()).append("\"> </i> ").appendHtmlEscaped(usageRow.getResourceName()).append("</span>");
	}
}
