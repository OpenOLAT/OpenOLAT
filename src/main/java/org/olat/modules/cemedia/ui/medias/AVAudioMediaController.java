 ...
 */
public class AVAudioMediaController extends BasicController {
	...
	private CollectAudioMediaController submissionDetailsController;

	@Autowired
	private VFSRepositoryService vfsRepositoryService;

	public AVAudioMediaController(UserRequest ureq, WindowControl wControl, String businessPath,
	...
	private void doSetSubmissionDetails(UserRequest ureq) {
		...
		submissionDetailsController = new CollectAudioMediaController(ureq, getWindowControl(), mObject, businessPath,
				true);
