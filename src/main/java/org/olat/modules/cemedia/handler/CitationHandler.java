...
public class CitationHandler extends AbstractMediaHandler implements PageElementStore<MediaPart>, InteractiveAddPageElementHandler {
	...
	@Override
	public Controller getMediaController(UserRequest ureq, WindowControl wControl, PageElement pageElement, MediaVersion mediaVersion, RenderingHints hints) {
		return new CitationMediaController(ureq, wControl, pageElement, mediaVersion, hints);
	}
