...
import org.olat.modules.coach.ui.CoachingNotificationsController;
 ...
 *
 */
public class CoachingUserTool implements UserTool {
	
	private final WindowControl wControl;
	private CoachingNotificationsController notificationsCtrl;

	public CoachingUserTool(WindowControl wControl) {
	...
	public Component getMenuComponent(UserRequest ureq, VelocityContainer container) {
		...
		Component cmp = notificationsCtrl.getInitialComponent();
