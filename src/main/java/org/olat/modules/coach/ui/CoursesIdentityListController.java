...
/**
 * Initial date: 28 Apr 2026<br>
 * @author uhensler, urs.hensler@frentix.com, https://www.frentix.com
 */
public class CoursesIdentityListController extends FormBasicController implements Activateable2, GenericEventListener {
	...
	public CoursesIdentityListController(UserRequest ureq, WindowControl wControl, TooledStackedPanel stackPanel,
			Identity assessedIdentity, boolean fullAccess) {
		super(ureq, wControl, "student_courses_table");
	...
	private void loadModel() {
		...
		List<CourseIdentityRow> rows = new ArrayList<>(courses.size());
	...
	private void doSelectDetails(UserRequest ureq, CourseIdentityRow entry) {
		...
		statementCtrl = new UserDetailsController(ureq, bwControl, stackPanel,
				entry.getStatementEntry(), assessedIdentity, entryIndex, tableModel.getRowCount(), selectedTool, true);
