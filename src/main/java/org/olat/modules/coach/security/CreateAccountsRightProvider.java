...
public class CreateAccountsRightProvider implements RightProvider {
	...
	public int getUserRelationsPosition() {
		return UserRelationRightsOrder.CreateAccountsRight.ordinal();
	}

	@Override
	public int getOrganisationPosition() {
		return OrganisationRightsOrder.CreateAccountsRight.ordinal();
	}
	...
	public String getTranslatedName(Locale locale) {
		...
		return translator.translate("relation.right.create.accounts");
	}
