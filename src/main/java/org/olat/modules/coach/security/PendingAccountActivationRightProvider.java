...
public class PendingAccountActivationRightProvider implements RightProvider {
	...
	public int getUserRelationsPosition() {
		return UserRelationRightsOrder.PendingAccountActivationRight.ordinal();
	}

	@Override
	public int getOrganisationPosition() {
		return OrganisationRightsOrder.PendingAccountActivationRight.ordinal();
	}
	...
	public String getTranslatedName(Locale locale) {
		...
		return translator.translate("relation.right.pending.account.activation");
	}
