...
public class ContactTracingStepContextWrapper {
    ...
    public QrIdGenerationMode getQrIdGenerationMode() {
		return qrIdGenerationMode;
	}
    
    public void setQrIdGenerationMode(QrIdGenerationMode qrIdGenerationMode) {
		this.qrIdGenerationMode = qrIdGenerationMode;
	}
    
    public enum QrIdGenerationMode {
    	numeric,
    	humanReadable;
    }
}
