 ...
 *
 */
public class GradingAdminController extends BasicController {
	...
	public GradingAdminController(UserRequest ureq, WindowControl wControl) {
		...
		configurationCtrl = new GradingAdminConfigurationController(ureq, wControl);
		listenTo(configurationCtrl);
		mainVC.put("config", configurationCtrl.getInitialComponent());

		templatesCtrl = new GradingAdminTemplatesController(ureq, wControl);
