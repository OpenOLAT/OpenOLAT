...
public class AppointmentsServiceImpl implements AppointmentsService, BigBlueButtonMeetingDeletionHandler, TeamsMeetingDeletionHandler {
	...
	public Appointment saveAppointment(Appointment appointment) {
		...
		if (bbbMeeting != null) {
			bbbMeeting = bigBlueButtonManager.updateMeeting(bbbMeeting, false);
		}
	...
	public Appointment addBBBMeeting(Appointment appointment, Identity identity) {
		...
		meeting.setRecordingsPublishingEnum(bigBlueButtonModule.defaultPublishValues());
		...
		meeting = bigBlueButtonManager.updateMeeting(meeting, false);
