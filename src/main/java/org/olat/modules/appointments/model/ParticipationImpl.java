 ...
 *
 */
@Entity(name="appointmentparticipation")
@Table(name="o_ap_participation")
public class ParticipationImpl implements Persistable, Participation {

	private static final long serialVersionUID = -4450368724916155445L;
