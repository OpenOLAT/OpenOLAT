 ...
 *
 */
public class ConfirmDeleteMessagesController extends FormBasicController {
	...
	public ConfirmDeleteMessagesController(UserRequest ureq, WindowControl wControl, List<AssessmentMessage> messagesToDelete) {
	...
	protected void initForm(FormItemContainer formLayout, Controller listener, UserRequest ureq) {
		if(formLayout instanceof FormLayoutContainer) {
			...
			String i18n = messagesToDelete.size() <= 1 ? "confirm.delete.text" : "confirm.delete.text.plural";
	...
	private void doDelete() {
		for(AssessmentMessage messageToDelete:messagesToDelete) {
			assessmentMessageService.deleteMessage(messageToDelete);
		}
	}
}
