...
public class AddMeetingController extends FormBasicController {
	...
	public AddMeetingController(UserRequest ureq, WindowControl wControl, TeamsRecurringMeetingsContext meetingsContext) {
		super(ureq, wControl, Util.createPackageTranslator(EditTeamsMeetingController.class, ureq.getLocale()));
	...
	protected boolean validateFormLogic(UserRequest ureq) {
		...
		if(dateEl.getDate() == null) {
			...
			List<TeamsRecurringMeeting> rMeetings = meetingsContext.getMeetings();
