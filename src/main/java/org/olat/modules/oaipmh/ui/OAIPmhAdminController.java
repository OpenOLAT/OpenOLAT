...
public class OAIPmhAdminController extends FormBasicController {
    ...
    private FormLayoutContainer restrictionsCont, apiCont, searchEngineCont, buttonsCont;
    ...
    protected void initForm(FormItemContainer formLayout, Controller listener, UserRequest ureq) {
        ...
        String[] sitemapKeys = new String[]{"oai.searchengine.google", "oai.searchengine.custom.sitemap"};
        ...
        String[] indexnowKeys = new String[]{"oai.searchengine.bing", "oai.searchengine.yandex", "oai.searchengine.custom.indexnow"};
    ...
    protected void formInnerEvent(UserRequest ureq, FormItem source, FormEvent event) {
	    if (source == oaiPmhEl) {
            ...
            if (searchEngineSitemapEl.isKeySelected("oai.searchengine.google")
                    && isValidInputUrl(googleTextEl.getValue())) {
                urlList.add(googleTextEl.getValue());
            }
            if (searchEngineSitemapEl.isKeySelected("oai.searchengine.custom.sitemap")
                    && isValidInputUrl(customSitemapTextEl.getValue())) {
                urlList.add(customSitemapTextEl.getValue());
            }
            if (searchEngineIndexnowEl.isKeySelected("oai.searchengine.bing")
                    && isValidInputUrl(bingTextEl.getValue())) {
                urlList.add(bingTextEl.getValue());
            }
            if (searchEngineIndexnowEl.isKeySelected("oai.searchengine.yandex")
                    && isValidInputUrl(yandexTextEl.getValue())) {
                urlList.add(yandexTextEl.getValue());
            }
            if (searchEngineIndexnowEl.isKeySelected("oai.searchengine.custom.indexnow")
    ...
    protected void formOK(UserRequest ureq) {
        ...
        if (searchEnginePublishEl.isOn()) {
            oaiPmhModule.setSearchEngineBing(searchEngineIndexnowEl.isKeySelected("oai.searchengine.bing"));
            oaiPmhModule.setSearchEngineBingUrl(bingTextEl.getValue());
            oaiPmhModule.setSearchEngineCustomSitemap(searchEngineSitemapEl.isKeySelected("oai.searchengine.custom.sitemap"));
            oaiPmhModule.setSearchEngineCustomSitemapUrl(customSitemapTextEl.getValue());
            oaiPmhModule.setSearchEngineCustomIndexnow(searchEngineIndexnowEl.isKeySelected("oai.searchengine.custom.indexnow"));
            oaiPmhModule.setSearchEngineCustomIndexnowUrl(customIndexTextEl.getValue());
            oaiPmhModule.setSearchEngineGoogle(searchEngineSitemapEl.isKeySelected("oai.searchengine.google"));
            oaiPmhModule.setSearchEngineGoogleUrl(googleTextEl.getValue());
            oaiPmhModule.setSearchEngineYandex(searchEngineIndexnowEl.isKeySelected("oai.searchengine.yandex"));
