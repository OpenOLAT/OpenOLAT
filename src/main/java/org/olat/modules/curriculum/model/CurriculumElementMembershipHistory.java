...
public class CurriculumElementMembershipHistory {
	...
	public void addHistoiryPoint(CurriculumRoles roles, GroupMembershipHistory point) {
		List<GroupMembershipHistory> historyByRole = membershipHistory.computeIfAbsent(roles, r -> new ArrayList<>());
