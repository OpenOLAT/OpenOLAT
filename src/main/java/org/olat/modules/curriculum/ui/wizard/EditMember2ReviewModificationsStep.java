 ...
 *
 */
public class EditMember2ReviewModificationsStep extends BasicStep {
	
	private final EditMembersContext membersContext;
	
	public EditMember2ReviewModificationsStep(UserRequest ureq, EditMembersContext membersContext) {
		super(ureq);
	...
	public StepFormController getStepController(UserRequest ureq, WindowControl wControl,
		...
		return new ReviewEditedMembershipsController(ureq, wControl, form, runContext, membersContext);
	}
}
