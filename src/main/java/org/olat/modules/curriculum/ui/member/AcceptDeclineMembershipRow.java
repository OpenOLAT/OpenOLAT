 ...
 *
 */
public class AcceptDeclineMembershipRow extends UserPropertiesRow {
	...
	public AcceptDeclineMembershipRow(Identity identity, List<UserPropertyHandler> userPropertyHandlers, Locale locale) {
