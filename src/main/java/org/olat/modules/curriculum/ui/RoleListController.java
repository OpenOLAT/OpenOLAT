...
public class RoleListController extends BasicController {
	...
	public RoleListController(UserRequest ureq, WindowControl wControl, CurriculumRoles[] roles) {
		super(ureq, wControl);
	...
	protected void event(UserRequest ureq, Component source, Event event) {
		if(source instanceof Link) {
			...
			if(link.getUserObject() instanceof CurriculumRoles) {
				fireEvent(ureq, new RoleEvent((CurriculumRoles)link.getUserObject()));
			}
		}
	}
}
