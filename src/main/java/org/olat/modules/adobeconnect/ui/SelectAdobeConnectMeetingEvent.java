 ...
 *
 */
public class SelectAdobeConnectMeetingEvent extends Event {

	private static final long serialVersionUID = 8960848450970463915L;

	public static final String SELECT = "select-adobeconnect-meeting";
	
	private final AdobeConnectMeeting meeting;
	
	public SelectAdobeConnectMeetingEvent(AdobeConnectMeeting meeting) {
		super(SELECT);
