 ...
 *
 */
public class GradeScoreRangeTable extends FormBaseComponentImpl {
	
	private static final GradeScoreRangeTableRenderer RENDERER = new GradeScoreRangeTableRenderer();
