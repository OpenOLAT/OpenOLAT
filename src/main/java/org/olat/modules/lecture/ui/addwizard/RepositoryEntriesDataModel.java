...
/**
 * 
 * Initial date: 11 oct. 2024<br>
 * @author srosse, stephane.rosse@frentix.com, http://www.frentix.com
 *
 */
public class RepositoryEntriesDataModel extends DefaultFlexiTableDataModel<RepositoryEntryRow> {

	private static final EntriesCols[] COLS = EntriesCols.values();
	
	public RepositoryEntriesDataModel(FlexiTableColumnModel columnsModel) {
		super(columnsModel);
	}
	
	@Override
	public Object getValueAt(int row, int col) {
		RepositoryEntryRow entryRow = getObject(row);
