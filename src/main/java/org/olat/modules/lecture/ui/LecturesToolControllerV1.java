 ...
 *
 */
public class LecturesToolControllerV1 extends BasicController implements BreadcrumbPanelAware, Activateable2 {
	...
	public LecturesToolControllerV1(UserRequest ureq, WindowControl wControl) {
		super(ureq, wControl);
		...
		teacherOverviewCtrl = new TeacherToolOverviewController(ureq, swControl, secCallback);
