 ...
 *
 */
@Entity(name="lectureparticipantcalsummary")
@Table(name="o_lecture_participant_summary")
public class LectureParticipantCalendarSummary implements Persistable {
	...
	public boolean equals(Object obj) {
		...
		if(obj instanceof LectureParticipantCalendarSummary) {
			LectureParticipantCalendarSummary summary = (LectureParticipantCalendarSummary)obj;
