 ...
 */
public interface CodeElement extends PageElement {
	...
	@Transient
	default CodeSettings getSettings() {
		if (StringHelper.containsNonWhitespace(getLayoutOptions())) {
			return ContentEditorXStream.fromXml(getLayoutOptions(), CodeSettings.class);
		}
		return new CodeSettings();
	}

	@Transient
	default void setSettings(CodeSettings codeSettings) {
