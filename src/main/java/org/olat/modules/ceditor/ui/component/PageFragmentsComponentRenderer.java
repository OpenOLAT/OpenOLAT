...
public class PageFragmentsComponentRenderer extends DefaultComponentRenderer {
	...
	private void render(Renderer renderer, StringOutput sb, PageFragment fragment, Map<String, PageFragment> elementIdToFragments,
		...
		if(element instanceof ContainerElement) {
			...
			sb.append("<div class='").append(fragment.getCssClass()).append(" clearfix'>");
			render(renderer, sb, container, elementIdToFragments, ubu, translator, renderResult, args);
		} else {
	...
	private void render(Renderer renderer, StringOutput sb, ContainerElement container, Map<String, PageFragment> elementIdToFragments,
			URLBuilder ubu, Translator translator, RenderResult renderResult, String[] args) {
		...
		for(int i=0; i<numOfColumns; i++) {
			sb.append("<div class='").append(cssColumns.get(i)).append("'>");
			if(i < columns.size()) {
