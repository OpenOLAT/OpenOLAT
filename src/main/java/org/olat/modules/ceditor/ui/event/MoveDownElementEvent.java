 ...
 *
 */
public class MoveDownElementEvent extends Event {

	private static final long serialVersionUID = 3300706246686745496L;

	public static final String MOVE_DOWN_ELEMENT = "ce-move-down-element";
	
	private final ContentEditorFragment component;
	
	public MoveDownElementEvent(ContentEditorFragment component) {
		super(MOVE_DOWN_ELEMENT);
