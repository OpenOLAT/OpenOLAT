...
public class ContainerHandler implements PageLayoutHandler, PageElementStore<ContainerElement>, SimpleAddPageElementHandler {
	...
	public PageElementEditorController getEditor(UserRequest ureq, WindowControl wControl, PageElement element) {
		if(element instanceof ContainerPart container) {
			return new ContainerEditorController(ureq, wControl, container, this, null);
		}
		return null;
	}
	...
	public PageElementInspectorController getInspector(UserRequest ureq, WindowControl wControl, PageElement element) {
		if(element instanceof ContainerElement container) {
			return new ContainerInspectorController(ureq, wControl, container, this);
		}
		return null;
	}
	...
	public ContainerElement savePageElement(ContainerElement element) {
		return CoreSpringFactory.getImpl(PageService.class).updatePart((ContainerPart)element);
	}
}
