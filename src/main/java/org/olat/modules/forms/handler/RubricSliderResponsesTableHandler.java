...
import org.olat.modules.forms.ui.multireport.RubricSliderResponsesTableController;
 ...
 *
 */
public class RubricSliderResponsesTableHandler implements EvaluationFormReportHandler {

	@Override
	public String getType() {
		return "rubricsliderresponsestable";
	}
	...
	public EvaluationFormReportElement getReportElement(UserRequest ureq, WindowControl windowControl, Form rootForm,
		...
		if (element instanceof Rubric rubric) {
			FormBasicController ctrl = new RubricSliderResponsesTableController(ureq, windowControl, rubric, filter, reportHelper, rootForm);
