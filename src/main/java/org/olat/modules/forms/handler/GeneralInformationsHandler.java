...
import org.olat.modules.forms.ui.GeneralInformationsController;
import org.olat.modules.forms.ui.GeneralInformationsEditorController;
 ...
 *
 */
public class GeneralInformationsHandler implements EvaluationFormElementHandler, SimpleAddPageElementHandler {
	
	private final boolean restrictedEdit;
	
	public GeneralInformationsHandler(boolean restrictedEdit) {
		this.restrictedEdit = restrictedEdit;
	}

	@Override
	public String getType() {
		return GeneralInformations.TYPE;
	}

	@Override
	public String getIconCssClass() {
		return "o_icon_eva_general_info";
	}
	...
	public PageRunElement getContent(UserRequest ureq, WindowControl wControl, PageElement element,
		...
		if(element instanceof GeneralInformations) {
			...
			EvaluationFormResponseController ctrl = new GeneralInformationsController(ureq, wControl, generalInformations);
	...
	public Controller getEditor(UserRequest ureq, WindowControl wControl, PageElement element) {
		if(element instanceof GeneralInformations) {
			GeneralInformations generalInformations = (GeneralInformations) element;
			return new GeneralInformationsEditorController(ureq, wControl, generalInformations, restrictedEdit);
		}
		return null;
	}
	...
	public EvaluationFormExecutionElement getExecutionElement(UserRequest ureq, WindowControl wControl, Form rootForm,
		...
		if (element instanceof GeneralInformations) {
			GeneralInformations generalInformations = (GeneralInformations) element;
			EvaluationFormResponseController ctrl = new GeneralInformationsController(ureq, wControl, generalInformations, rootForm);
			return new EvaluationFormResponseControllerElement(ctrl);
		}
		return null;
	}
