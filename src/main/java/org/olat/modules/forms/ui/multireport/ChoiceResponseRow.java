 ...
 *
 */
public class ChoiceResponseRow {
	
	private final Choice choice;
	private List<String> responseFullNames = new ArrayList<>();
	
	private FormBasicController detailsCtrl;
	
	public ChoiceResponseRow(Choice choice) {
		this.choice = choice;
	}
	...
	public String getChoiceValue() {
		return choice == null ? null : choice.getValue();
	}

	public int getNumOfResponses() {
		return responseFullNames.size();
	}

	public void addResponse(String fullName) {
		responseFullNames.add(fullName);
	}
	
	public List<String> getResponsesFullNames() {
		return responseFullNames;
	}
