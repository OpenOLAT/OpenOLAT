...
public class ZoomRunController extends BasicController implements Activateable2 {
    ...
    public ZoomRunController(UserRequest ureq, WindowControl wControl,
        ...
        if (zoomConfig == null) {
            ...
            ltiCtrl = new LTI13DisplayController(ureq, wControl, zoomConfig.getLtiContext(), null, false, admin, coach, participant);
    ...
    private Component getAssistanceAccordion(UserRequest ureq, VelocityContainer vc) {
        ...
        assistanceAccordionCtrl.setHelpLink("help.additional.informations",
                "manual_user/learningresources/Frequentyl_asked_questions_Zoom/");
