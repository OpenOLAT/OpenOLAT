 ...
 *
 */
public class SharedFolderRuntimeController extends RepositoryEntryRuntimeController {
	
	public SharedFolderRuntimeController(UserRequest ureq, WindowControl wControl,
