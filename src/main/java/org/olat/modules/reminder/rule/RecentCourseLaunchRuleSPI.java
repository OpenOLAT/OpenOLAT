 ...
 */
@Service
public class RecentCourseLaunchRuleSPI extends AbstractLaunchDateRuleSPI {
	...
	public String getLabelI18nKey() {
		return "rule.recent.course.launch.date";
	}
	...
	public String getStaticText(ReminderRule rule, RepositoryEntry entry, Locale locale) {
		if (rule instanceof ReminderRuleImpl) {
			...
			return translator.translate("rule.recent.course.launch.date." + currentUnit, args);
		}
		return null;
	}
