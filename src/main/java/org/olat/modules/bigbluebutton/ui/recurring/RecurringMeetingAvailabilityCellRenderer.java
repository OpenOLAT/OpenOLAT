 ...
 *
 */
public class RecurringMeetingAvailabilityCellRenderer implements FlexiCellRenderer {
	...
	public void render(Renderer renderer, StringOutput target, Object cellValue, int row, FlexiTableComponent source,
		...
		if(cellValue instanceof Boolean) {
			...
			if(meeting.isDeleted()) {
				...
				target.append("<span><i class='o_icon o_icon_accept'> </i></span>");
			} else {
				target.append("<span><i class='o_icon o_icon_reject'> </i></span>");
			}
		}
	}
}
