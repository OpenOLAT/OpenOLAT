 ...
 *
 */
public class BigBlueButtonCollaborationSettingsController extends FormBasicController {
	 ...
	 */
	public BigBlueButtonCollaborationSettingsController(UserRequest ureq, WindowControl wControl, String access) {
		super(ureq, wControl);
		this.access = access;
		initForm(ureq);
	}
	...
	protected void initForm(FormItemContainer formLayout, Controller listener, UserRequest ureq) {
		...
		formLayout.setElementCssClass("o_sel_collaboration_bigbluebutton");
		...
		submit.setElementCssClass("o_sel_collaboration_bigbluebutton_save");
	}
