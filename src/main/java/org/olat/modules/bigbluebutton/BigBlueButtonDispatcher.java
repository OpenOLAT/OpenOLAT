...
import org.olat.modules.bigbluebutton.ui.BigBlueButtonGuestCreator;
 ...
 *
 */
public class BigBlueButtonDispatcher implements Dispatcher {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(pathInfo != null && pathInfo.contains("close-window")) {
			...
			BigBlueButtonMeeting meeting = getMeeting(request);
			dispatch(ureq, meeting, uriPrefix);
		}
	}
	
	private void dispatch(UserRequest ureq, BigBlueButtonMeeting meeting, String uriPrefix) {
	...
	private BigBlueButtonMeeting getMeeting(HttpServletRequest request) {
		String uriPrefix = DispatcherModule.getLegacyUriPrefix(request);
		...
		return CoreSpringFactory.getImpl(BigBlueButtonManager.class).getMeeting(restPart);
	}
}
