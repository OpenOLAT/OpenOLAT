 ...
 */
@Component
public class EdusharingDirectiveProvider implements CSPDirectiveProvider {
	...
	private Collection<String> getUrls() {
		return edusharingModule.isEnabled()? Collections.singletonList(edusharingModule.getBaseUrl()): null;
	}
