 ...
 */
@Component
public class OpenMeetingsDirectiveProvider implements CSPDirectiveProvider {
	...
	private Collection<String> getUrls() {
		return openMeetingsModule.isEnabled()? Collections.singletonList(openMeetingsModule.getOpenMeetingsURI().toString()): null;
	}
