 ...
 *
 */
public class QEducationalContextsAdminTreeNode extends GenericTreeNode implements ControllerTreeNode {
	...
	public Controller getController(UserRequest ureq, WindowControl wControl) {
		if(controller == null) {
			WindowControl swControl = BusinessControlFactory.getInstance().createBusinessWindowControl(ureq, ORES, null,
					wControl, true);
			controller = new QEducationalContextsAdminController(ureq, swControl);
		} 
		return controller;
	}
}
