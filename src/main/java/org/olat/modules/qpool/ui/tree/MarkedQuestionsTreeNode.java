 ...
 *
 */
public class MarkedQuestionsTreeNode extends GenericTreeNode implements ControllerTreeNode {

	private static final long serialVersionUID = -4546025987046093829L;
	
	public static final OLATResourceable ORES = OresHelper.createOLATResourceableType("Marked");
	private static final String ICON_CSS_CLASS = "o_icon_pool_favorits o_sel_qpool_favorits";
	private static final String ITEM_SOURCE_NAME = "Fav";
	private static final String TABLE_PREFERENCE_PREFIX = "favorit";
	private static final String USER_OBJECT = "Marked";
	
	private final TooledStackedPanel stackPanel;
	private QuestionsController questionsCtrl;

	public MarkedQuestionsTreeNode(String title, TooledStackedPanel stackPanel) {
		super();
