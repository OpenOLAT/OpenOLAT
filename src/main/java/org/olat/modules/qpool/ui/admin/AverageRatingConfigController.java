 ...
 *
 */
public class AverageRatingConfigController extends FormBasicController implements ReviewDecisionConfigController {
...
//	private static final String AVERAGE_RATING_FOR_FINAL = "average.rating.for.final";
	...
	public AverageRatingConfigController(UserRequest ureq, WindowControl wControl) {
		super(ureq, wControl);
	...
	public Map<String, String> getConfiguration() {
		...
		config.put("numberOfRatings", numberOfRatingForFinalEl.getValue());
		config.put("lowerLimit", averageRatingForFinalEl.getValue());
		return config;
	}

	@Override
	protected void initForm(FormItemContainer formLayout, Controller listener, UserRequest ureq) {
//		String numberOfRatingsForFinal = Integer.toString(qpoolModule.getReviewDecisionProviderType());
