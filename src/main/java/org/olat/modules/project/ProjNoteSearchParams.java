 ...
 *
 */
public class ProjNoteSearchParams {
	
	private ProjProjectRef project;
	private Collection<Long> noteKeys;
	...
	public Collection<Long> getNoteKeys() {
		return noteKeys;
	}
	
	public void setNotes(Collection<? extends ProjNoteRef> notes) {
		this.noteKeys = notes.stream().map(ProjNoteRef::getKey).collect(Collectors.toList());
	}
