...
public class ProjectMailing {
	...
	private static ProjProjectMailTemplate createMailTemplate(ProjProject project, Identity actor, String subjectKey,
			String bodyKey) {
	...
	public static class ProjProjectMailTemplate extends MailTemplate {
		...
		public ProjProjectMailTemplate(String subject, String body, ProjProject project, Identity actor,
				Locale locale) {
