...
public interface ProjActivity extends CreateInfo {
	...
	public static List<Action> TIMELINE_ACTIONS = List.of(
			...
			Action.projectImageAvatarUpdate,
			Action.projectImageBackgroundUpdate,
	...
	public enum Action {
		...
		projectImageAvatarUpdate(ActionTarget.project),
		...
		fileRestore(ActionTarget.file),
		fileStatusDelete(ActionTarget.file),
		fileDeletePermanently(ActionTarget.file),
		...
		appointmentCopyInitialized(ActionTarget.appointment),
		...
		milestoneCopyInitialized(ActionTarget.milestone),
