 ...
 */
public class ProjectsContextEntryControllerCreator extends DefaultContextEntryControllerCreator {
	
	private final ProjectModule projectModule;
	
	public ProjectsContextEntryControllerCreator(ProjectModule projectModule) {
	...
	public String getSiteClassName(List<ContextEntry> ces, UserRequest ureq) {
		return ProjectsSite.class.getName();
	}
