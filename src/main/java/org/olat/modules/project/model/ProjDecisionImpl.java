 ...
 *
 */
@Entity(name="projdecision")
@Table(name="o_proj_decision")
public class ProjDecisionImpl implements ProjDecision, Persistable {
	
	private static final long serialVersionUID = -7145095142831024798L;
	...
	@Column(name="p_details", nullable=true, insertable=true, updatable=true)
	private String details;
	@Column(name="p_decision_date", nullable=true, insertable=true, updatable=true)
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ProjDecisionImpl other = (ProjDecisionImpl) obj;
		if (key == null) {
			if (other.key != null)
				return false;
