 ...
 *
 */
public class ProjMilestoneInfoImpl extends ProjArtefactInfoImpl implements ProjMilestoneInfo {
	
	private ProjMilestone milestone;

	public ProjMilestoneInfoImpl(ProjMilestone milestone, ProjArtefactInfo artefactInfo) {
		super(artefactInfo);
