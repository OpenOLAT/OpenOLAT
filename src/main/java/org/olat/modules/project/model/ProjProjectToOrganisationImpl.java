 ...
 *
 */
@Entity(name="projprojecttoorganisation")
@Table(name="o_proj_project_to_org")
public class ProjProjectToOrganisationImpl implements ProjProjectToOrganisation, Persistable, CreateInfo {
	...
	public boolean equals(Object obj) {
		...
		if(obj instanceof ProjProjectToOrganisationImpl) {
			ProjProjectToOrganisationImpl rel = (ProjProjectToOrganisationImpl)obj;
