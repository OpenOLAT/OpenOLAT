 ...
 *
 */
@Entity(name="projnote")
@Table(name="o_proj_note")
public class ProjNoteImpl implements ProjNote, Persistable  {
	
	private static final long serialVersionUID = 2801959800098024477L;
	...
	@Column(name="p_text", nullable=true, insertable=true, updatable=true)
	private String text;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ProjNoteImpl other = (ProjNoteImpl) obj;
		if (key == null) {
			if (other.key != null)
				return false;
