...
import org.olat.modules.organisation.OrganisationModule;
 ...
 *
 */
public class OrganisationAdminController extends BasicController {
	...
	private OrganisationTreeAdminController organisationListCtrl;
	...
	public OrganisationAdminController(UserRequest ureq, WindowControl wControl) {
		...
		if(organisationModule.isEnabled()) {
			organisationListLink = LinkFactory.createLink("organisation.list", mainVC, this);
	...
	private void doOpenOrganisationList(UserRequest ureq) {
		if(organisationListCtrl == null) {
			...
			organisationListCtrl = new OrganisationTreeAdminController(ureq, bwControl);
