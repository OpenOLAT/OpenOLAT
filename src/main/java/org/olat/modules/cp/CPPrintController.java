...
/**
 * 
 * Initial date: 25 mars 2022<br>
 * @author srosse, stephane.rosse@frentix.com, http://www.frentix.com
 *
 */
public class CPPrintController extends BasicController {
	
	public CPPrintController(UserRequest ureq, WindowControl wControl,
			CPManifestTreeModel ctm, VFSContainer rootContainer) {
		super(ureq, wControl);

		VelocityContainer mainVC = createVelocityContainer("print");
