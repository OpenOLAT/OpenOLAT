 ...
 *
 */
public class SectionSelectionEvent extends Event {
	
	private static final long serialVersionUID = 3559566708817370123L;
	public static final String SELECT_SECTION = "pf-select-section";
	
	private SectionRef section;
	
	public SectionSelectionEvent(SectionRef section) {
		super(SELECT_SECTION);
