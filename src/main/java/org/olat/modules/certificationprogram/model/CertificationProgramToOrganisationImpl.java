 ...
 *
 */
@Entity(name="certificationprogramtoorganisation")
@Table(name="o_cer_program_to_organisation")
public class CertificationProgramToOrganisationImpl implements Persistable, CertificationProgramToOrganisation {
	...
	public boolean equals(Object obj) {
		...
		if(obj instanceof CertificationProgramToOrganisationImpl) {
			CertificationProgramToOrganisationImpl rel = (CertificationProgramToOrganisationImpl)obj;
