 ...
 *
 */
public class NextRecertificationInDaysFlexiCellRenderer implements FlexiCellRenderer {
	
	private final Translator translator;
	
	public NextRecertificationInDaysFlexiCellRenderer(Translator translator) {
