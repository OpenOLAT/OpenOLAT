 ...
 *
 */
public class CertificationProgramStatusCellRenderer implements FlexiCellRenderer {
	
	private final Translator translator;
	
	public CertificationProgramStatusCellRenderer(Translator translator) {
	...
	public void render(Renderer renderer, StringOutput target, Object cellValue, int row, FlexiTableComponent source,
		...
		if(cellValue instanceof CertificationProgramStatusEnum status) {
	...
	public static final void getStatus(StringOutput target, String type, Enum<?> status, Translator trans) {
		target.append("<span class=\"").append(type).append(" o_certification_status_")
		      ...
		      .append("<i class=\"o_icon o_icon-fw o_icon_certification_status_").append(status.name()).append("\"> </i> ")
		      .append(trans.translate("certification.status.".concat(status.name())))
		      .append("</span>");
	}
