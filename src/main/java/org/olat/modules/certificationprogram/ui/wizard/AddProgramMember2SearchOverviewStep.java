 ...
 * @author srosse, stephane.rosse@frentix.com, httpa://www.frentix.com
 *
 */
public class AddProgramMember2SearchOverviewStep extends BasicStep {
	
	private final AddProgramMembersContext membersContext;
	
	public AddProgramMember2SearchOverviewStep(UserRequest ureq, AddProgramMembersContext membersContext,
			BasicStepCollection stepCollection) {
		super(ureq);
		this.membersContext = membersContext;
		
		setI18nTitleAndDescr("wizard.select", "wizard.select");
		setStepCollection(stepCollection);
		setNextStep(new AddProgramMember3OptionStep(ureq, membersContext));
	}
