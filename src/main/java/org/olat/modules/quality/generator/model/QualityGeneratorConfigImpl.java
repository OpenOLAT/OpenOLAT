 ...
 *
 */
@Entity(name="qualitygeneratorconfig")
@Table(name="o_qual_generator_config")
public class QualityGeneratorConfigImpl implements QualityGeneratorConfig, Persistable {
	
	private static final long serialVersionUID = -6607354930513711724L;
	...
	@Column(name="q_value", nullable=false, insertable=true, updatable=true)
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		QualityGeneratorConfigImpl other = (QualityGeneratorConfigImpl) obj;
		if (key == null) {
			if (other.key != null)
				return false;
