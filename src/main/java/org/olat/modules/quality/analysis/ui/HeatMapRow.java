...
public class HeatMapRow {
	...
	private List<GroupedStatistic> statistics;
	
	public HeatMapRow(Long groupKey, List<String> groupNames) {
	...
	public void setStatistics(List<GroupedStatistic> statistics) {
