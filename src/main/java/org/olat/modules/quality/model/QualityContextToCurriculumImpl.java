 ...
 *
 */
@Entity(name="contexttocurriculum")
@Table(name="o_qual_context_to_curriculum")
public class QualityContextToCurriculumImpl  implements QualityContextToCurriculum, Persistable {
	...
	@ManyToOne(targetEntity=CurriculumImpl.class,fetch=FetchType.LAZY,optional=false)
	@JoinColumn(name="fk_curriculum", nullable=false, insertable=true, updatable=false)
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		QualityContextToCurriculumImpl other = (QualityContextToCurriculumImpl) obj;
		if (key == null) {
			if (other.key != null)
				return false;
	...
	public String toString() {
		...
		builder.append("QualityContextToCurriculumImpl [key=");
		builder.append(key);
		builder.append(", contextKey=");
		builder.append(context != null? context.getKey(): "");
		builder.append(", curriculumKey=");
		builder.append(curriculum != null? curriculum.getKey(): "");
		builder.append("]");
