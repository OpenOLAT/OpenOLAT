 ...
 *
 */
@Entity(name="qualityauditlog")
@Table(name="o_qual_audit_log")
public class QualityAuditLogImpl implements QualityAuditLog, Persistable {
	...
	@Column(name="q_action", nullable=false, insertable=true, updatable=false)
	private Action action;

	@Column(name="q_before", nullable=true, insertable=true, updatable=false)
	private String before;	
	@Column(name="q_after", nullable=true, insertable=true, updatable=false)
	...
	@JoinColumn(name="fk_todo_task", nullable=true, insertable=true, updatable=false)
	...
	public boolean equals(Object obj) {
		...
		if(obj instanceof QualityAuditLogImpl) {
			QualityAuditLogImpl activity = (QualityAuditLogImpl)obj;
