...
public class ToDoTaskEditForm extends FormBasicController {
	...
	private final Collection<? extends TagRef> currentTags;
	...
	public ToDoTaskEditForm(UserRequest ureq, WindowControl wControl, Form mainForm, ToDoTask toDoTask,
			Collection<Identity> availableIdentities, Collection<Identity> currentAssignee,
			Collection<Identity> currentDelegatee, List<? extends TagInfo> allTags, Collection<? extends TagRef> currentTags) {
	...
	protected void initForm(FormItemContainer formLayout, Controller listener, UserRequest ureq) {
		...
		if (ToDoStatus.done == toDoTask.getStatus()) {
		...
		tagsEl = uifactory.addTagSelection("tags", "tags", formLayout, getWindowControl(), allTags, currentTags);
