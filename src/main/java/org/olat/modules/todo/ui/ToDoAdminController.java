 ...
 *
 */
public class ToDoAdminController extends BasicController implements Activateable2 {
	...
	private ToDoAdminSettingsController settingsCtrl;

	public ToDoAdminController(UserRequest ureq, WindowControl wControl) {
		super(ureq, wControl);
	...
	private void doOpenSettings(UserRequest ureq) {
		if (settingsCtrl == null) {
			...
			settingsCtrl = new ToDoAdminSettingsController(ureq, swControl);
