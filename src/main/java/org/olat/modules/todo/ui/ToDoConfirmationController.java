...
/**
 * 
 * Initial date: 24 Aug 2022<br>
 * @author uhensler, urs.hensler@frentix.com, http://www.frentix.comm
 *
 */
public class ToDoConfirmationController extends FormBasicController {
	...
	public ToDoConfirmationController(UserRequest ureq, WindowControl wControl, String message,
	...
	protected ToDoConfirmationController(UserRequest ureq, WindowControl wControl, String message,
