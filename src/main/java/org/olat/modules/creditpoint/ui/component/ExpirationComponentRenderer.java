 ...
 *
 */
public class ExpirationComponentRenderer extends DefaultComponentRenderer {

	@Override
	public void renderComponent(Renderer renderer, StringOutput sb, Component source, URLBuilder ubu,
			Translator translator, RenderResult renderResult, String[] args) {
		ExpirationComponent expCmp = (ExpirationComponent)source;
		ExpirationFormItem item = expCmp.getFormItem();
