 ...
 *
 */
public interface CreditPointSecurityCallback {
	
	/**
	 * @return true if allowed to add points to the wallet
	 */
	boolean canAddTransaction();
	
	/**
	 * @return true if allowed to remove points from the wallet
	 */
	boolean canRemoveTransaction();
