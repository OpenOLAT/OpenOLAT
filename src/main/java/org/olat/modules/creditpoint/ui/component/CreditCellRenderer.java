 ...
 *
 */
public class CreditCellRenderer implements FlexiCellRenderer {
	
	private final CreditPointSystem system;
	
	public CreditCellRenderer(CreditPointSystem system) {
		this.system = system;
	}
	...
	public void render(Renderer renderer, StringOutput target, Object cellValue, int row, FlexiTableComponent source,
		...
		if(cellValue instanceof BigDecimal amount) {
			String formattedAmount = CreditPointFormat.format(amount, system);
			target.append("<span class='o_creditpoint_amount_credit'>+</span>")
