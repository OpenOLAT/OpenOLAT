 ...
 *
 */
@Entity(name="creditpointrepositoryentry")
@Table(name="o_cp_repositoryentry_config")
public class RepositoryEntryCreditPointConfigurationImpl implements Persistable, RepositoryEntryCreditPointConfiguration {
	
	private static final long serialVersionUID = -6424272359230140321L;
	...
	@Column(name="c_expiration", nullable=true, insertable=true, updatable=true)
	private Integer expiration;
	@Enumerated(EnumType.STRING)
	@Column(name="c_expiration_unit", nullable=true, insertable=true, updatable=true)
	private CreditPointExpirationType expirationType;
	...
	public RepositoryEntryCreditPointConfigurationImpl() {
		//
	}
	...
	@Override
	public CreditPointExpirationType getExpirationType() {
		return expirationType;
	}

	@Override
	public void setExpirationType(CreditPointExpirationType type) {
	...
	@Override
	public int hashCode() {
		return getKey() == null ? 7410546 : getKey().hashCode();
	}
	...
	public boolean equals(Object obj) {
		...
		if(obj instanceof RepositoryEntryCreditPointConfigurationImpl config) {
