 ...
 *
 */
public class CatalogFilterRow {
	
	private final CatalogFilter catalogFilter;
	private CatalogFilterHandler handler;
	private String translatedType;
	private String details;
	private UpDown upDown;
	private FormLink toolsLink;

	public CatalogFilterRow(CatalogFilter catalogFilter) {
	...
	public void setHandler(CatalogFilterHandler handler) {
