 ...
 *
 */
@Entity(name="cataloglauncher")
@Table(name="o_ca_launcher")
public class CatalogLauncherImpl implements CatalogLauncher, Persistable, CreateInfo, ModifiedInfo {

	private static final long serialVersionUID = -6819877091137519196L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CatalogLauncherImpl other = (CatalogLauncherImpl) obj;
		if (key == null) {
			if (other.key != null)
				return false;
	...
	@Override
	public int compareTo(CatalogLauncher o) {
