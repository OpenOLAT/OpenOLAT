 ...
 */
@Component
public class Card2BrainDirectiveProvider implements CSPDirectiveProvider {
	...
	private Collection<String> getUrls() {
		return card2BrainModule.isEnabled()? Collections.singletonList(card2BrainModule.getVerifyLtiUrl()): null;
	}
