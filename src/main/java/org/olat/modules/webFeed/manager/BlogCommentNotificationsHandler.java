 ...
 */
@Service
public class BlogCommentNotificationsHandler extends FeedCommentNotificationsHandler {

	public static final String TYPE = "Comment.BLOG";
	public static final String CSS_CLASS_ICON_BLOG = "o_blog_icon";
	public static final String NOTIFICATIONS_HEADER_COMMENT_BLOG = "notifications.header.comment.blog";
	...
	protected List<Item> getItems(Publisher p) {
		OLATResourceable feedOres = OresHelper.createOLATResourceableInstance(BlogFileResource.TYPE_NAME, Long.valueOf(p.getData()));
