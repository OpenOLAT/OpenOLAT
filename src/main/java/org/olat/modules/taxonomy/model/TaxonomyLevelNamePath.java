...
/**
 * 
 * Initial date: 20 Jul 2022<br>
 * @author uhensler, urs.hensler@frentix.com, http://www.frentix.com
 *
 */
public class TaxonomyLevelNamePath {
	
	private final String displayName;
	private final String materializedPathIdentifiersWithoutSlash;
	
	public TaxonomyLevelNamePath(String displayName, String materializedPathIdentifiersWithoutSlash) {
