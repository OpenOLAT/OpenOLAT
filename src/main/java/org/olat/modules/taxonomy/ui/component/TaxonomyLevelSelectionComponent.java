...
public class TaxonomyLevelSelectionComponent extends AbstractComponent {
	...
	private final TaxonomyLevelSelectionImpl taxonomyLevelSelection;

	public TaxonomyLevelSelectionComponent(String name, TaxonomyLevelSelectionImpl taxonomyLevelSelection) {
		super(name);
