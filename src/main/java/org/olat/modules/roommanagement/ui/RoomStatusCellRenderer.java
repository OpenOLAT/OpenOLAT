 ...
 */
public class RoomStatusCellRenderer extends LabelCellRenderer {
	@Override
	protected String getCellValue(Object val, Translator translator) {
		return val instanceof RoomStatus s ? translator.translate("building.status." + s.name()) : "";
	}

	@Override
	protected String getIconCssClass(Object val) {
		return val instanceof RoomStatus s ? "o_icon-fw o_icon_rm_status_" + s.name() : "";
	}

	@Override
	protected String getElementCssClass(Object val) {
		return val instanceof RoomStatus s ? "o_rm_status_" + s.name() : "";
	}
}
