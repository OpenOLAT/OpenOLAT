...
public class ApplicationReviewCommentComparator implements Comparator<ApplicationReviewComment> {
	...
	@Override
	public int compare(ApplicationReviewComment o1, ApplicationReviewComment o2) {
		ApplicationComment c1 = o1.getApplicationComment();
		ApplicationComment c2 = o2.getApplicationComment();
		if(c1 == null && c2 == null) {
			return 0;
		} else if(c1 == null) {
			return 1;
		...
		ApplicationComment p1 = c1.getParentComment();
		ApplicationComment p2 = c2.getParentComment();
		if((p1 == null && p2 == null) || (p1 != null && p1.equals(p2))) {
			return compareCommentWithSameParent(c1, c2);
		}
		
		List<ApplicationReviewComment> parentLine1 = getParentLine(o1);
		List<ApplicationReviewComment> parentLine2 = getParentLine(o2);
		...
		if(pp1.equals(pp2)) {
			...
			if(pp1.equals(pp2)) {
				...
				c = compareCommentWithSameParent(pp1.getApplicationComment(), pp2.getApplicationComment());
			}
		}
		return c;
	}
	...
	private int compareCommentWithSameParent(ApplicationComment c1, ApplicationComment c2) {
