 ...
 *
 */
public class ConfirmDeleteFeedbackController extends FormBasicController {
	...
	public ConfirmDeleteFeedbackController(UserRequest ureq, WindowControl wControl,
	...
	private void doDelete(UserRequest ureq) {
		...
		String messageI18n = "audit.log.member.feedback.delete";
		String[] args = getLogArguments();
		auditService.auditFeedbackLog(Action.delete, before, null, messageI18n, args, getTranslator(), position, application, null, getIdentity());
		
		feedback.setComment(null);
		feedback.setCommentDate(null);
