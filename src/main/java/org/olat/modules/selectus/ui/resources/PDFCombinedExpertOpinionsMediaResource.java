 ...
 *
 */
public class PDFCombinedExpertOpinionsMediaResource implements MediaResource {
	
	private static final Logger log = Tracing.createLoggerFor(PDFCombinedExpertOpinionsMediaResource.class);
	...
	public PDFCombinedExpertOpinionsMediaResource(Application application, Position position,
	...
	public void prepare(HttpServletResponse hres) {
		...
		String fileName = helper.getExpertOpinionsFilename();
		...
		try(OutputStream out = hres.getOutputStream()) {
			helper.combineExpertOpinionsStreamed(out);
		} catch (IOException e) {
			log.error("", e);
		}
	}
