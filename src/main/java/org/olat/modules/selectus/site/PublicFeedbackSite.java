...
import org.olat.modules.selectus.ui.feedback.publicfeedback.PublicFeedbackMainController;
 ...
 *
 */
public class PublicFeedbackSite implements SiteInstance {
	
	private DefaultNavElement curNavElem;
	private NavElement origNavElem;
	
	public PublicFeedbackSite(Locale locale) {
	...
	public MainLayoutController createController(UserRequest ureq, WindowControl wControl) {
		return new PublicFeedbackMainController(ureq, wControl);
	}
