...
public class ApplicationCommentImpl implements ApplicationComment, Persistable {
	...
	@Column(name="r_deleted", nullable=false, unique=false, insertable=true, updatable=true)
	private boolean deleted;
	
	@Column(name="r_comment", nullable=true, unique=false, insertable=true, updatable=true)
	...
	@JoinColumn(name="fk_reviewer_id", nullable=true, insertable=true, updatable=false)
	...
	@ManyToOne(targetEntity=ApplicationCommentImpl.class, fetch=FetchType.LAZY, optional=true)
	@JoinColumn(name="fk_app_comment_id", nullable=true, insertable=true, updatable=false)
	...
	public void setParentComment(ApplicationComment parentComment) {
	...
	public boolean equals(Object obj) {
		...
		if(obj instanceof ApplicationCommentImpl) {
			ApplicationCommentImpl comment = (ApplicationCommentImpl)obj;
			return getKey() != null && getKey().equals(comment.getKey());
		}
		return false;
	}
