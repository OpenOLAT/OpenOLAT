...
public class RecruitingAuditLogUserSettingsImpl implements Persistable, RecruitingAuditLogUserSettings {
	...
	@Column(name="r_interval", nullable=true, insertable=true, updatable=true)
