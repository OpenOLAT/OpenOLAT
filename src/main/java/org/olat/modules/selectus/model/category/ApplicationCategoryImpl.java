...
public class ApplicationCategoryImpl implements ApplicationCategory, Persistable {
	...
	@Column(name="r_administrative", nullable=false, unique=false, insertable=true, updatable=true)
	...
	@JoinColumn(name="fk_category_id", nullable=false, insertable=true, updatable=true)
	...
	public boolean equals(Object obj) {
		...
		if(obj instanceof ApplicationCategoryImpl) {
			ApplicationCategoryImpl appCat = (ApplicationCategoryImpl)obj;
			return getKey() != null && getKey().equals(appCat.getKey());
		}
		return false;
	}
