...
public class ApplicationDecisionImpl implements Persistable {
	...
	public ApplicationDecisionImpl() {
		//
	}
	...
	public boolean equals(Object obj) {
		...
		if(obj instanceof ApplicationDecisionImpl) {
			ApplicationDecisionImpl app = (ApplicationDecisionImpl)obj;
	...
	public String toString() {
		...
		sb.append("applicationDecision[")
			.append(super.toString())
			.append(key == null ? "" : key.toString())
			.append(decision == null ? "" : decision.toString());
		return sb.toString();
	}
}
