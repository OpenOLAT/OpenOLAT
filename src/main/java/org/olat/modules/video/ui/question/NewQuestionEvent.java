...
public class NewQuestionEvent extends Event {
	...
	private static final long serialVersionUID = -6150147363979234999L;
	public static final String NEW_QUESTION_EVENT = "new-question-item";
	
	private final VideoQuestion question;
	
	public NewQuestionEvent(VideoQuestion question) {
		super(NEW_QUESTION_EVENT);
