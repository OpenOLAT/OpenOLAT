...
public class VideoAssessmentItemController extends BasicController implements OutcomesAssessmentItemListener {
	...
	public boolean present(UserRequest ureq, VideoQuestion question, List<VideoQuestion> allAvailableQuestions) {
		...
		AssessmentEntry assessmentEntry = assessmentService.getOrCreateAssessmentEntry(getIdentity(), null, entry, subIdent, entryRoot, videoEntry, false);
	...
	public void outcomes(String resultIdentifier, AssessmentTestSession candidateSession, Float score, Boolean pass, SessionStatus sessionStatus) {
		...
		AssessmentEntry assessmentEntry = assessmentService
				.getOrCreateAssessmentEntry(getIdentity(), null, entry, subIdent, entryRoot, videoEntry, false);
