 ...
 *
 */
public class NullObligationContext implements ObligationContext {
	
	private static final NullObligationContext CONTEXT = new NullObligationContext();
	
	public static final NullObligationContext create() {
		return CONTEXT;
	}

	private NullObligationContext() {
		//
	}
