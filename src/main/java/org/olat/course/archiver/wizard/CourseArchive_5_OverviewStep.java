 ...
 *
 */
public class CourseArchive_5_OverviewStep extends BasicStep {
	
	private final CourseArchiveContext archiveContext;
	
	public CourseArchive_5_OverviewStep(UserRequest ureq, CourseArchiveContext archiveContext) {
		super(ureq);
	...
	public StepFormController getStepController(UserRequest ureq, WindowControl wControl,
		...
		return new CourseArchiveOverviewController(ureq, wControl, archiveContext, stepsRunContext, form );
	}
