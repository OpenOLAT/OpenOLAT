 ...
 *
 */
public class CourseArchiveElementRow implements FlexiTreeTableNode, IndentedCourseNode {

	private boolean hasChildren = false;
	private final CourseNode courseNode;
	private final CourseArchiveElementRow parent;
	
	public CourseArchiveElementRow(CourseNode courseNode, CourseArchiveElementRow parent) {
