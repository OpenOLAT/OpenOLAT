 ...
 *
 */
public class BulkCoursesArchives_3_OverviewStep extends BasicStep {

	private final BulkCoursesArchivesContext archiveContext;
	
	public BulkCoursesArchives_3_OverviewStep(UserRequest ureq, BulkCoursesArchivesContext archiveContext) {
		super(ureq);
	...
	public StepFormController getStepController(UserRequest ureq, WindowControl wControl,
		...
		return new BulkCoursesArchivesOverviewController(ureq, wControl, archiveContext, runContext, form);
	}
}
