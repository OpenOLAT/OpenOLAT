 ...
 *
 */
public class PublicationStep extends BasicStep {
	
	public PublicationStep(UserRequest ureq) {
		super(ureq);
		setTranslator(Util.createPackageTranslator(CourseWizardService.class, getLocale(), getTranslator()));
		setI18nTitleAndDescr("wizard.title.publication", null);
	...
	public StepFormController getStepController(UserRequest ureq, WindowControl windowControl,
		...
		return new PublicationController(ureq, windowControl, form, stepsRunContext);
	}
