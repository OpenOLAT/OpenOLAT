 ...
 *
 */
public class BulkAssessment_4_ScheduleStep extends BasicStep {
	
	public BulkAssessment_4_ScheduleStep(UserRequest ureq) {
		super(ureq);
		setI18nTitleAndDescr("schedule.title", "schedule.title");
	}
