 ...
 *
 */
public class ConfirmCancelInspectionController extends FormBasicController {
	...
	public ConfirmCancelInspectionController(UserRequest ureq, WindowControl wControl, List<AssessmentInspection> inspectionList) {
		super(ureq, wControl, "confirm_cancel_inspections");
	...
	protected void initForm(FormItemContainer formLayout, Controller listener, UserRequest ureq) {
		if(formLayout instanceof FormLayoutContainer layoutCont) {
			String msgI18n = inspectionList.size() == 1 ? "confirm.bulk.cancel.singular" : "confirm.bulk.cancel.plural";
		...
		uifactory.addFormSubmitButton("bulk.cancel", "bulk.cancel", formLayout);
	...
	protected void formOK(UserRequest ureq) {
		...
		for(AssessmentInspection inspection:inspectionList) {
			inspectionService.cancelInspection(inspection, comment, getIdentity());
		}
