 ...
 *
 */
public class CreateInspection_2_ParticipantsStep extends BasicStep {
	
	private final CreateInspectionContext context;
	
	public CreateInspection_2_ParticipantsStep(UserRequest ureq, CreateInspectionContext context) {
		super(ureq);
		this.context = context;
		
		setNextStep(new CreateInspection_3_InspectionStep(ureq, context));
		setI18nTitleAndDescr("wizard.choose.participants.title", "wizard.choose.participants.descr");
	}
