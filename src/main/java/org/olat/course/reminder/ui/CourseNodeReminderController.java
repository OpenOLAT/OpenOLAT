...
public class CourseNodeReminderController extends BasicController {
	...
	public CourseNodeReminderController(UserRequest ureq, WindowControl wControl, BreadcrumbPanel toolbarPanel,
			RepositoryEntry repositoryEntry, CourseNodeReminderProvider reminderProvider) {
		super(ureq, wControl);
		
		remindersCtrl = new CourseReminderListController(ureq, wControl, toolbarPanel, repositoryEntry, reminderProvider,
				"node.reminders.intro");
	...
	public boolean hasReminders() {
		return remindersCtrl.hasReminders();
	}
