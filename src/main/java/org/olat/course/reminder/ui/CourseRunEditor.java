...
import org.olat.course.reminder.rule.CourseRunRuleSPI;
 ...
 *
 */
public class CourseRunEditor extends RuleEditorFragment {
	...
	public CourseRunEditor(ReminderRule rule) {
		super(rule);
	}

	@Override
	public FormItem initForm(FormItemContainer formLayout, Controller listener, UserRequest ureq) {
		String page = Util.getPackageVelocityRoot(this.getClass()) + "/course_run.html";
	...
	public ReminderRule getConfiguration() {
		...
		configuredRule.setType(CourseRunRuleSPI.class.getSimpleName());
