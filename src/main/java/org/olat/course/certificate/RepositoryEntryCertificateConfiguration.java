 ...
 *
 */
public interface RepositoryEntryCertificateConfiguration extends CreateInfo, ModifiedInfo {
	...
	public void setAutomaticCertificationEnabled(boolean certificationAutomaticEnabled);

	public boolean isManualCertificationEnabled();

	public void setManualCertificationEnabled(boolean certificationManualEnabled);
	...
	public void setValidityEnabled(boolean b);
	...
	public void setValidityTimelapseUnit(CertificationTimeUnit timeUnit);
	...
	public void setRecertificationLeadTimeEnabled(boolean b);
	
	public int getRecertificationLeadTimeInDays();
	
	public void setRecertificationLeadTimeInDays(int days);
