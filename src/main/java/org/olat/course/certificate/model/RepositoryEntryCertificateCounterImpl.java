 ...
 *
 */
@Entity(name="certificateentrycounter")
@Table(name="o_cer_entry_config")
public class RepositoryEntryCertificateCounterImpl implements Persistable {
	
	private static final long serialVersionUID = -5383679984764119542L;
	...
	@Override
	public int hashCode() {
		return getKey() == null ? -94857 : getKey().hashCode();
	}
	...
	public boolean equals(Object obj) {
		...
		if(obj instanceof RepositoryEntryCertificateCounterImpl counter) {
