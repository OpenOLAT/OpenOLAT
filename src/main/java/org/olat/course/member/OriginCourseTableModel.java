 ...
 */
public class OriginCourseTableModel extends DefaultFlexiTableDataModel<OriginCourseRow> {
	
	private static final Cols[] COLS = Cols.values();
	
	public OriginCourseTableModel(FlexiTableColumnModel columnModel) {
		super(columnModel);
	}

	@Override
	public Object getValueAt(int row, int col) {
		OriginCourseRow rowObj = getObject(row);
		return getValueAt(rowObj, col);
	}
	
	private Object getValueAt(OriginCourseRow row, int col) {
