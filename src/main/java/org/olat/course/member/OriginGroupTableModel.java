 ...
 */
public class OriginGroupTableModel extends DefaultFlexiTableDataModel<OriginGroupRow> {
	
	private static final Cols[] COLS = Cols.values();
	
	public OriginGroupTableModel(FlexiTableColumnModel columnModel) {
		super(columnModel);
	}

	@Override
	public Object getValueAt(int row, int col) {
		OriginGroupRow rowObj = getObject(row);
