 ...
 *
 */
public class InvitationPermissionChoiceController extends StepFormBasicController {
	private EditSingleOrImportMembershipController permissionCtrl;
	
	private final InvitationContext context;

	public InvitationPermissionChoiceController(UserRequest ureq, WindowControl wControl,
			InvitationContext invitationContext, Form rootForm, StepsRunContext runContext) {
		super(ureq, wControl, rootForm, runContext, LAYOUT_BAREBONE, null);
		this.context = invitationContext;
		
		permissionCtrl = new EditSingleOrImportMembershipController(ureq, getWindowControl(), invitationContext, rootForm);
	...
	protected void formOK(UserRequest ureq) {
		...
		context.setMemberPermissions(e);
