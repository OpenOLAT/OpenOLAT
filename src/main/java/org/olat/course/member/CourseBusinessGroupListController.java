...
public class CourseBusinessGroupListController extends AbstractBusinessGroupListController {
	...
	protected void doSelectGroups(UserRequest ureq) {
		...
		List<GroupRoles> restrictToRoles = (roles.isGroupManager() || roles.isAdministrator()) ? null : List.of(GroupRoles.coach);
		selectController = new SelectBusinessGroupController(ureq, getWindowControl(), filter, restrictToRoles, null);
