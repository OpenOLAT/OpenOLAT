...
public class OverviewListController extends FormBasicController implements FlexiTableCssDelegate {
	...
	private void initTable(UserRequest ureq, FormItemContainer formLayout) {
		...
		descriptionModel.setCellRenderer(new TextFlexiCellRenderer(EscapeMode.antisamy));
		...
		objectivesModel.setCellRenderer(new TextFlexiCellRenderer(EscapeMode.antisamy));
		...
		instructionModel.setCellRenderer(new TextFlexiCellRenderer(EscapeMode.antisamy));
		...
		instructionalDesignModel.setCellRenderer(new TextFlexiCellRenderer(EscapeMode.antisamy));
