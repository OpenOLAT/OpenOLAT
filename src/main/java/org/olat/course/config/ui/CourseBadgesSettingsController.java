 ...
 */
public class CourseBadgesSettingsController extends BasicController {
	...
	protected CourseBadgesSettingsController(UserRequest ureq, WindowControl wControl, TooledStackedPanel stackPanel,
