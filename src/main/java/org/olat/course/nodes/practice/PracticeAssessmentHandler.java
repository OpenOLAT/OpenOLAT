 ...
 */
@Service
public class PracticeAssessmentHandler extends LearningPathOnlyAssessmentHandler {

	private static final AssessmentConfig PRACTICE_CONFIG = new PracticeAssessmentConfig();
