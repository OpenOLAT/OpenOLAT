 ...
 */
@Service
public class PracticeLearningPathNodeHandler implements LearningPathNodeHandler {
	
	private static final LearningPathEditConfigs EDIT_CONFIGS = LearningPathEditConfigs.builder()
			.enableNodeVisited()
			.enableConfirmed()
			.enableStatusDone()
			.withTranslations(PracticeRunController.class)
	...
	public String acceptCourseNodeType() {
		return PracticeCourseNode.TYPE;
	}
