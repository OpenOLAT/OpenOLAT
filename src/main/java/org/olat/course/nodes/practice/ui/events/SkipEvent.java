...
/**
 * 
 * Initial date: 2 juin 2022<br>
 * @author srosse, stephane.rosse@frentix.com, http://www.frentix.com
 *
 */
public class SkipEvent extends Event {
	
	private static final long serialVersionUID = 1449506594375122971L;

	public static final String SKIP_EVENT = "skip-event";

	private PracticeAssessmentItemGlobalRef golbalRef;
	
	public SkipEvent(PracticeAssessmentItemGlobalRef golbalRef) {
		super(SKIP_EVENT);
