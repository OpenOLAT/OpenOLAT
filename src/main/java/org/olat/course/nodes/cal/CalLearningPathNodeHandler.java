 ...
 */
@Service
public class CalLearningPathNodeHandler implements LearningPathNodeHandler {
	...
	public void onMigrated(CourseNode courseNode) {
		if (courseNode instanceof CalCourseNode) {
			((CalCourseNode)courseNode).removeCustomPreconditions();
		}
	}
