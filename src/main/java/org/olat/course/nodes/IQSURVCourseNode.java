...
public class IQSURVCourseNode extends AbstractAccessableCourseNode {
	...
	public TabbableController createEditController(UserRequest ureq, WindowControl wControl, ICourse course, UserCourseEnvironment euce) {
		TabbableController childTabCntrllr = IQUIFactory.createIQSurveyEditController(ureq, wControl, course, this, course.getCourseEnvironment().getCourseGroupManager(), euce);
