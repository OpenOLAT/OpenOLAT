 ...
 *
 */
public class EdusharingEditController extends ActivateableTabbableDefaultController implements ControllerEventListener {

	public static final String PANE_TAB_CONFIG = "pane.tab.config";
	private final static String[] paneKeys = { PANE_TAB_CONFIG };

	private EdusharingConfigController configController;
	private TabbedPane tabPane;
	
	public EdusharingEditController(UserRequest ureq, WindowControl wControl, BreadcrumbPanel stackPanel,
			EdusharingCourseNode courseNode, RepositoryEntry courseEntry) {
		super(ureq, wControl);

		configController = new EdusharingConfigController(ureq, wControl, stackPanel, courseNode, courseEntry);
