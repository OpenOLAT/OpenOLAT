 ...
 *
 */
public class GTAEditEvaluationConfigController extends FormBasicController {
	
	private FormToggle evaluationFormEnabledEl;
	
	private ModuleConfiguration config;
	
	public GTAEditEvaluationConfigController(UserRequest ureq, WindowControl wControl, ModuleConfiguration config) {
		super(ureq, wControl);
		this.config = config;
	...
	public boolean isEvaluationEnabled() {
		return evaluationFormEnabledEl.isOn();
	}
	...
	protected void formInnerEvent(UserRequest ureq, FormItem source, FormEvent event) {
		if(evaluationFormEnabledEl == source) {
			updateConfig();
