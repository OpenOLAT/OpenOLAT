...
/**
 * 
 * Initial date: 9 juil. 2024<br>
 * @author srosse, stephane.rosse@frentix.com, http://www.frentix.com
 *
 */
public class TaskListSessionFilter implements SessionFilter {
	
	private final TaskList taskList;
	private final List<TaskReviewAssignmentStatus> status;
	
	public TaskListSessionFilter(TaskList taskList, List<TaskReviewAssignmentStatus> status) {
