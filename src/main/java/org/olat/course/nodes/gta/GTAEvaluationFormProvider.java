 ...
 */
@Service
public class GTAEvaluationFormProvider implements EvaluationFormProvider {
	
	public static final String SURVEY_ORES_TYPE_NAME = "course-gta";
	
	public static final String PARTICIPATION_TYPE_NAME = "gta-course-node";
