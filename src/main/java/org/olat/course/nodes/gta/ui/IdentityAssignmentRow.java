 ...
 *
 */
public class IdentityAssignmentRow extends UserPropertiesRow {
	
	private final String taskName;
	private final SingleSelection coachChoices;
	private final AssessmentEntry assessmentEntry;
	
	public IdentityAssignmentRow(String taskName, SingleSelection coachChoices, AssessmentEntry assessmentEntry,
			Identity identity, List<UserPropertyHandler> userPropertyHandlers, Locale locale) {
		super(identity, userPropertyHandlers, locale);
		this.taskName = taskName;
		this.coachChoices = coachChoices;
