...
/**
 * Event for handling communication between DialogElementListCtrl and DialogCourseNodeRunCtrl
 * <p>
 * Initial date: Jun 21, 2023
 *
...
public class DialogRunEvent extends Event {
	...
	public DialogRunEvent(DialogElement element) {
		super(OPEN_DISCUSSION);
