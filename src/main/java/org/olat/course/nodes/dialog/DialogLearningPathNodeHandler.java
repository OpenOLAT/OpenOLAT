 ...
 */
@Service
public class DialogLearningPathNodeHandler implements LearningPathNodeHandler {

	private static final LearningPathEditConfigs NODE_TYPE_CONFIG= LearningPathEditConfigs.builder()
			.enableNodeVisited()
			.enableConfirmed()
			.build();
	...
	public void onMigrated(CourseNode courseNode) {
		if (courseNode instanceof DialogCourseNode) {
			DialogCourseNode dialogNode = (DialogCourseNode)courseNode;
			dialogNode.removeCustomPreconditions();
		}
	}
