 ...
 */
@Service
public class MSEvaluationFormProvider implements EvaluationFormProvider {
	
	public static final String SURVEY_ORES_TYPE_NAME = "course-ms";
	
	public static final String PARTICIPATION_TYPE_NAME = "ms-course-node";
