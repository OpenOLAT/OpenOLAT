...
/**
 * 
 * Initial date: Jan 20, 2026<br>
 * @author uhensler, urs.hensler@frentix.com, https://www.frentix.com
 *
 */
public class MSToolsController extends AbstractToolsController {

	public MSToolsController(UserRequest ureq, WindowControl wControl, CourseNode courseNode, Identity assessedIdentity,
	...
	protected EvaluationFormProvider getEvaluationFormProvider() {
		return MSCourseNode.getEvaluationFormProvider();
	}
