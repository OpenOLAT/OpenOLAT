...
public class IQCommunicationController extends BasicController implements Activateable2 {
	...
	private void doAddParticipants(UserRequest ureq) {
		MemberSearchConfig config = MemberSearchConfig.defaultConfig(entry, GroupRoles.owner,
				"iq-communication-identitity-v1.0")
				.onlyRunningTestSessions(true, courseNode.getIdent());
