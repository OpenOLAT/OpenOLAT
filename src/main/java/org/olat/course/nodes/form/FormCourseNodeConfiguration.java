 ...
 *
 */
public class FormCourseNodeConfiguration extends AbstractCourseNodeConfiguration {
	...
	public CourseNode getInstance(INode parent) {
		return new FormCourseNode(parent);
	}

	@Override
	public String getLinkText(Locale locale) {
		Translator translator = Util.createPackageTranslator(FormEditController.class, locale);
		return translator.translate("course.node.link.text");
	}

	@Override
	public String getIconCSSClass() {
		return FormCourseNode.ICON_CSS;
	}
