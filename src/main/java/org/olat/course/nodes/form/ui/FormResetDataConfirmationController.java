...
public class FormResetDataConfirmationController extends FormBasicController {
	...
	protected void initForm(FormItemContainer formLayout, Controller listener, UserRequest ureq) {
		...
		String message = translate("reset.all.message", String.valueOf(allSessions), String.valueOf(doneSessions));
	...
	protected boolean validateFormLogic(UserRequest ureq) {
		...
		if(!confirmationEl.isAtLeastSelected(1)) {
			confirmationEl.setErrorKey("reset.all.confirmation.error");
			allOk &= false;
		}
