 ...
 */
public class IsNotInAttributeOperator extends AbstractOperator {

	public transient final String OPERATOR = "isNotInAttribute";
	public transient final String OPERATORKEY = "isnotin";
	public transient final String DISPLAY  = "operator.isNotInAttribute";
