 ...
 */
public class HasAttributeOperator extends AbstractOperator {

	public transient final String OPERATOR = "hasAttribute";
	public transient final String OPERATORKEY = "has";
	public transient final String DISPLAY  = "operator.hasAttribute";
