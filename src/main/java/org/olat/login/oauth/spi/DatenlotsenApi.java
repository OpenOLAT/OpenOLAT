 ...
 *
 */
public class DatenlotsenApi extends DefaultApi20 {

	private final DatenlotsenProvider provider;

	public DatenlotsenApi(DatenlotsenProvider provider) {
