...
alter table o_user add column u_genericselectionproperty4 varchar(255);
alter table o_user add column u_genericselectionproperty5 varchar(255);
...
alter table o_user add column u_genericcheckboxproperty4 varchar(255);
alter table o_user add column u_genericcheckboxproperty5 varchar(255);
alter table o_user add column u_genericyesnoproperty varchar(255);
alter table o_user add column u_genericyesnoproperty2 varchar(255);
alter table o_user add column u_genericyesnoproperty3 varchar(255);
alter table o_user add column u_genericyesnoproperty4 varchar(255);
alter table o_user add column u_genericyesnoproperty5 varchar(255);
...
update o_user set u_genericselectionproperty4=(select propvalue from o_userproperty where user_id=fk_user_id and propname='genericSelectionProperty4') where u_genericselectionproperty4 is null;
update o_user set u_genericselectionproperty5=(select propvalue from o_userproperty where user_id=fk_user_id and propname='genericSelectionProperty5') where u_genericselectionproperty5 is null;
...
update o_user set u_genericcheckboxproperty4=(select propvalue from o_userproperty where user_id=fk_user_id and propname='genericCheckboxProperty4') where u_genericcheckboxproperty4 is null;
update o_user set u_genericcheckboxproperty5=(select propvalue from o_userproperty where user_id=fk_user_id and propname='genericCheckboxProperty5') where u_genericcheckboxproperty5 is null;
update o_user set u_genericyesnoproperty=(select propvalue from o_userproperty where user_id=fk_user_id and propname='genericYesNoProperty') where u_genericyesnoproperty is null;
update o_user set u_genericyesnoproperty2=(select propvalue from o_userproperty where user_id=fk_user_id and propname='genericYesNoProperty2') where u_genericyesnoproperty2 is null;
update o_user set u_genericyesnoproperty3=(select propvalue from o_userproperty where user_id=fk_user_id and propname='genericYesNoProperty3') where u_genericyesnoproperty3 is null;
update o_user set u_genericyesnoproperty4=(select propvalue from o_userproperty where user_id=fk_user_id and propname='genericYesNoProperty4') where u_genericyesnoproperty4 is null;
update o_user set u_genericyesnoproperty5=(select propvalue from o_userproperty where user_id=fk_user_id and propname='genericYesNoProperty5') where u_genericyesnoproperty5 is null;
