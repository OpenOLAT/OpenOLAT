...
alter table o_noti_pub add column fk_root_publisher int8;
alter table o_noti_pub add column fk_parent_publisher int8;
...
alter table o_bs_identity add column expirationdate timestamp;
alter table o_bs_identity add column expirationemaildate timestamp;
