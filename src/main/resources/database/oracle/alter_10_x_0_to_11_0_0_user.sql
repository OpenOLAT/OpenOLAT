...
alter table o_user add u_genericselectionproperty4 varchar2(255 char);
alter table o_user add u_genericselectionproperty5 varchar2(255 char);
...
alter table o_user add u_genericcheckboxproperty4 varchar2(255 char);
alter table o_user add u_genericcheckboxproperty5 varchar2(255 char);
alter table o_user add u_genericyesnoproperty varchar2(255 char);
alter table o_user add u_genericyesnoproperty2 varchar2(255 char);
alter table o_user add u_genericyesnoproperty3 varchar2(255 char);
alter table o_user add u_genericyesnoproperty4 varchar2(255 char);
alter table o_user add u_genericyesnoproperty5 varchar2(255 char);
