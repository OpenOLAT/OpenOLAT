...
CREATE TABLE o_repositoryentry (
  ...
  show_lectures number default 0 not null,
  show_certificate number default 1 not null,
  show_creditpoints number default 1 not null,
  taught_by varchar2(255 char),
  ...
  catalog_sort_priority number(20),
...
create table o_todo_task (
   ...
   t_due_date date,
   t_done_date date,
   t_relative_dates varchar(2000 char),
   t_type varchar(50),
...
create table o_ac_offer (
  ...
  cancelling_enabled number default 1 not null,
...
create table o_teams_meeting (
   ...
   t_record number default 0 not null,
   t_record_auto_start number default 0 not null,
   t_organizer_azure_id varchar(255),
   t_organizer_token CLOB,
   fk_entry_id number(20) default null,
   a_sub_ident varchar(64) default null,
   fk_group_id number(20) default null,
   fk_creator_id number(20) default null,
   fk_organizer_id number(20),
   primary key (id)
);
...
create table o_as_mode_course (
   ...
   a_safeexambrowser_allow_exit number default 0,
...
create table o_cer_certificate (
   ...
   c_recertification_count number(20),
   c_recertification_win_date date,
   ...
   c_generation_retries number(20) default 0 not null,
   c_generation_next_date date,
   c_generation_data CLOB,
   fk_olatresource number(20),
   fk_identity number(20) not null,
   fk_metadata number(20),
   fk_print_metadata number(20),
   fk_certification_program number(20),
   fk_uploaded_by number(20),
   primary key (id)
);
...
create table o_cer_entry_config (
  ...
  c_sn_enabled number default 0 not null,
  c_sn_format varchar(255),
  c_sn_start_number number(20) default 1 not null,
  c_sn_counter number(20) default 0 not null,
...
create table o_cer_program (
   ...
   c_sn_start_number number(20) default 1 not null,
   c_sn_counter number(20) default 0 not null,
   c_print_template_enabled number default 0 not null,
   fk_credit_point_system number(20),
   fk_group number(20) not null,
   fk_template number(20),
   fk_print_template number(20),
   fk_resource number(20),
   primary key (id)
);
...
create table o_cer_program_mail_config (
   ...
   c_time number(20) default 0 not null,
   c_time_unit varchar(32),
   c_balance_too_low number default 0 not null,
   c_i18n_suffix varchar(64) not null,
   c_i18n_customized number default 0 not null,
   fk_program number(20) not null,
   primary key (id)
);
...
CREATE TABLE o_selectus_position (
  ...
  conf_mail_subject varchar(255) default null,
  conf_mail_template CLOB DEFAULT NULL,
  conf_mail_subject_de varchar(255) DEFAULT NULL,
  conf_mail_template_de CLOB DEFAULT NULL,
  conf_mail_subject_fr varchar(255) DEFAULT NULL,
  conf_mail_template_fr CLOB DEFAULT NULL,
  conf_mail_letter CLOB DEFAULT NULL,
  conf_mail_subject_mgmt varchar(255) default null,
  conf_mail_template_mgmt CLOB DEFAULT NULL,
  conf_mail_subject_mgmt_de varchar(255) default null,
  conf_mail_template_mgmt_de CLOB DEFAULT NULL,
  conf_mail_subject_mgmt_fr varchar(255) default null,
  conf_mail_template_mgmt_fr CLOB DEFAULT NULL,
  conf_mail_letter_mgmt CLOB DEFAULT NULL,
  confdup_mail_subject varchar(255) default null,
  confdup_mail_template CLOB DEFAULT NULL,
  confdup_mail_subject_de varchar(255) DEFAULT NULL,
  confdup_mail_template_de CLOB DEFAULT NULL,
  confdup_mail_subject_fr varchar(255) DEFAULT NULL,
  ...
  confsub_expert_mail_template CLOB default null,
  ...
  confsub_referee_mail_template CLOB default null,
  ...
  confs_comp_expert_mail_template CLOB default null,
