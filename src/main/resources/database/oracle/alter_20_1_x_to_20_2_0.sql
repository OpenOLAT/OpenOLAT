...
alter table o_cer_certificate add fk_uploaded_by number(20);
alter table o_cer_certificate add c_revocation_date date;
alter table o_cer_certificate add c_removal_date date;
...
-- Credit point
alter table o_cp_system add c_org_restrictions number default 0 not null;
alter table o_cp_system add c_roles_restrictions number default 0 not null;
