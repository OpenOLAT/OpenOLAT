...
create table if not exists o_repositoryentry (
   ...
   show_lectures bool default false not null,
   show_certificate bool default true not null,
   show_creditpoints bool default true not null,
...
create table o_repositoryentry_cycle (
   ...
   r_defaultpubliccycle bit default 0,
...
create table  if not exists o_ac_offer (
  ...
  cancelling_enabled bool default true not null,
...
create table if not exists o_ac_order (
  ...
  cancellation_fee_lines_amount decimal(12,4),
...
create table o_ca_launcher (
   ...
   c_web_enabled bool not null default true,
...
create table o_as_entry (
   ...
   a_weighted_score float(65,30) default null,
   a_score_scale float(65,30) default null,
   a_max_score float(65,30) default null,
   a_weighted_max_score float(65,30) default null,
   a_grade varchar(100),
   a_grade_system_ident varchar(64),
   a_performance_class_ident varchar(50),
   a_passed bit default null,
   a_passed_date datetime,
...
create table o_as_mode_course (
   ...
   a_safeexambrowserconfig_dload bool not null default true,
...
create table o_as_seb_template (
   ...
   a_safeexambrowserauthorhint mediumtext,
   primary key (id)
);
...
create table o_cer_certificate (
   ...
   c_recertification_count bigint,
   ...
   c_generation_retries bigint default 0 not null,
   c_generation_next_date datetime,
   c_generation_data mediumtext,
...
create table o_cer_entry_config (
  ...
  c_sn_start_number bigint default 1 not null,
  c_sn_counter bigint default 0 not null,
...
create table o_vid_metadata (
  ...
  vid_master_replaced boolean not null default false,
  fk_resource_id bigint not null,
  primary key (id)
);
...
create table o_gta_task (
   ...
   g_collection_revisions_date datetime,
   ...
   g_peerreview_completed_date datetime,
...
create table o_lecture_block (
  ...
  fk_meeting bigint default null,
  fk_teams bigint default null,
  primary key (id)
);
...
create table o_cur_element_type (
  ...
  c_max_repo_entries bigint default -1 not null,
...
create table o_cur_curriculum_element (
  ...
  c_show_certificate boolean default false,
  c_show_creditpoints boolean default false,
  fk_group bigint not null,
  fk_resource bigint,
  fk_parent bigint,
...
create table o_cur_automation_execution (
  id bigint not null auto_increment,
  creationdate datetime not null,
  c_execution_date datetime not null,
...
create table o_ap_appointment (
   ...
   a_use_enrollment_deadline bool default false not null,
   a_enrollment_deadline_minutes bigint default 0 not null,
   fk_topic_id bigint not null,
   fk_meeting_id bigint,
   fk_teams_id bigint,
   primary key (id)
...
create table o_badge_class (
   ...
   b_private_key text default null,
   b_public_key text default null,
   fk_entry bigint,
...
create table o_selectus_position (
   ...
   confsub_expert_mail_subject text(255) default null,
   confsub_expert_mail_template mediumtext default null,
   ...
   confsub_referee_mail_subject text(255) default null,
   confsub_referee_mail_template mediumtext default null,
   ...
   confs_comp_expert_mail_subject text(255) default null,
   confs_comp_expert_mail_template mediumtext default null,
...
alter table o_media ENGINE = InnoDB;
alter table o_media_tag ENGINE = InnoDB;
...
alter table o_ce_page_body ENGINE = InnoDB;
alter table o_ce_page ENGINE = InnoDB;
alter table o_pf_binder ENGINE = InnoDB;
alter table o_pf_assessment_section ENGINE = InnoDB;
alter table o_ce_assignment ENGINE = InnoDB;
alter table o_pf_binder_user_infos ENGINE = InnoDB;
alter table o_ce_page_to_tax_competence ENGINE = InnoDB;
...
alter table o_cur_automation_config ENGINE = InnoDB;
alter table o_cur_automation_rule ENGINE = InnoDB;
alter table o_cur_automation_execution ENGINE = InnoDB;
...
alter table o_feed_tag ENGINE = InnoDB;
...
alter table o_rm_building ENGINE = InnoDB;
alter table o_rm_building_to_org ENGINE = InnoDB;
