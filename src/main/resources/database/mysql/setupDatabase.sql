...
create table if not exists o_user (
   ...
   u_studysubject text,
   u_emchangekey text,
   u_emaildisabled text,
   u_typeofuser text,
   u_socialsecuritynumber text,

   u_rank text,
   u_degree text,
   u_position text,
   u_userinterests text,
   u_usersearchedinterests text,
   u_officestreet text,
   u_extendedofficeaddress text,
   u_officepobox text,
   u_officezipcode text,
   u_officecity text,
   u_officecountry text,
   u_officemobilephone text,
   u_department text,
   u_privateemail text,
   u_employeenumber text,
   u_organizationalunit text,

   u_edupersonaffiliation text,
   u_swissedupersonstaffcategory text,
   u_swissedupersonhomeorg text,
   u_swissedupersonstudylevel text,
   u_swissedupersonhomeorgtype text,
   u_swissedupersonstudybranch1 text,
   u_swissedupersonstudybranch2 text,
   u_swissedupersonstudybranch3 text,

   u_genericselectionproperty text,
   u_genericselectionproperty2 text,
   u_genericselectionproperty3 text,
   u_generictextproperty text,
   u_generictextproperty2 text,
   u_generictextproperty3 text,
   u_generictextproperty4 text,
   u_generictextproperty5 text,
   u_genericuniquetextproperty text,
   u_genericuniquetextproperty2 text,
   u_genericuniquetextproperty3 text,
   u_genericemailproperty1 text,
   u_genericcheckboxproperty text,
   u_genericcheckboxproperty2 text,
   u_genericcheckboxproperty3 text,
