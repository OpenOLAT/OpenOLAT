...
find * -type f -name "*.css" -exec sed -i .orig "s/\.c20/\.b_c20/g" {} \;
...
find * -type f -name "*.css" -exec sed -i .orig "s/\.c40/\.b_c40/g" {} \;
find * -type f -name "*.css" -exec sed -i .orig "s/\.c50/\.b_c50/g" {} \;
find * -type f -name "*.css" -exec sed -i .orig "s/\.c60/\.b_c60/g" {} \;
...
find * -type f -name "*.css" -exec sed -i .orig "s/\.c80/\.b_c80/g" {} \;
...
find * -type f -name "*.css" -exec sed -i .orig "s/\.equalize/\.b_equalize/g" {} \;
find * -type f -name "*.css" -exec sed -i .orig "s/\.noprint/\.b_noprint/g" {} \;
