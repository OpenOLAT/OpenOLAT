...
(function() {
	...
	var register = function (editor, url) {
		...
		var insertLatex = function(dialogApi) {
		...
		function showDialog() {
			...
			mathLiveHtml += '<math-field id="mathlive" virtual-keyboard-mode="onfocus">' + data.latex + '</math-field>';
			...
			function updatePreview(dialogApi) {
				...
				if(tex == null || tex.length == 0) {
					...
					emptyHtml += "<h3 class='o_empty_msg' style='font-family: sans-serif;'>" + translator().translate('olatmatheditor.empty.title') + "</h3>";
