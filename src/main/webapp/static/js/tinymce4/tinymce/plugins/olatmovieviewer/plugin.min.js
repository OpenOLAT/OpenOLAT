...
(function() {
	...
	function previewIframe(editor) {
		...
		node.src = contextPath + '/raw/openolat162a-dev/movie/player.js';
		...
		node.src = contextPath + '/raw/openolat162a-dev/movie/mediaelementjs/mediaelement-and-player.min.js';
		node.type = 'text/javascript';
		node.async = true;
		node.charset = 'utf-8';
		iframeHead.appendChild(node);
		...
		node = iframeWindow.document.createElement('script');
		node.src = contextPath + '/raw/openolat162a-dev/js/jquery/jquery-3.6.0.min.js';
		node.type = 'text/javascript';
		node.async = true;
		node.charset = 'utf-8';
		iframeHead.appendChild(node);
		...
		node.href = contextPath + '/raw/openolat162a-dev/movie/mediaelementjs/mediaelementplayer.min.css';
		iframeHead.appendChild(node);
