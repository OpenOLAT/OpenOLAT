	...
	tinymce.create('org.olat.core.gui.components.form.flexible.impl.elements.richText.plugins.olatmovieviewer', {
		...
		init : function(ed, url) {
			...
			function insertVideo() {
				...
				var sel = /mceItemOlatMovieViewer/.test(ed.dom.getAttrib(fe, 'class'));
				console.log('selection test',ed.dom.getAttrib(fe, 'class'));
				console.log('selection test 2',sel);
			...
			function parseBPlayerScript(editor,script) {
				...
				console.log('parseBPlayerScript', pl);
				return pl;
			};
			...
			ed.on('SetContent', function(e) {
				...
				ed.parser.addNodeFilter('div,span,script', function(nodes) {
					var i = nodes.length, node, childNode;
					while (i--) {
						node = nodes[i];
					
						console.log('script and co.', node);
					}
				});
				...
				tinymce.each(ed.dom.select("div.olatFlashMovieViewer,span.olatFlashMovieViewer"), function(node, index) {
					
					var innerHtml = node.firstChild && node.firstChild.value;
