(function ($) {
    ...
    function timesUp(settings) {
    	...
    	if(jQuery('#o_qti_run').length > 0) {
    		o_ffXHREvent(settings.formName, settings.dispIdField, settings.dispId, settings.eventIdField, '2', false, false, false, false, 'cid', 'timesUp');
    	}
    }
